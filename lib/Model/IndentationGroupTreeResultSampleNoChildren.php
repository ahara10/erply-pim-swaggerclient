<?php
/**
 * IndentationGroupTreeResultSampleNoChildren
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * IndentationGroupTreeResultSampleNoChildren Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class IndentationGroupTreeResultSampleNoChildren implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'indentation.GroupTreeResultSampleNoChildren';
