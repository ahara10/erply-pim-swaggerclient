...
/**
 * ParammodelsSortRequest Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ParammodelsSortRequest implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'parammodels.SortRequest';
    ...
    /**
     * Sets desc
     * @param bool $desc If true - descending, if false - ascending
     * @return $this
     */
    ...
    /**
     * Sets language
     * @param string $language Language in ISO 639-1 standard. Is needed only for translatable properties like description and name.
     * @return $this
     */
    ...
    /**
     * Sets selector
     * @param string $selector JSON field. For description: description_plain or description_html
     * @return $this
     */
