<?php
/**
 * MatrixmodelsProductBulkCreateRequestItem
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * MatrixmodelsProductBulkCreateRequestItem Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class MatrixmodelsProductBulkCreateRequestItem implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'matrixmodels.ProductBulkCreateRequestItem';
    ...
    protected static $swaggerTypes = array(
        ...
        'matrix_product' => '\Swagger\Client\Model\ProductsProductRequest'
    );
    ...
    {
        $this->container['dimension_ids'] = isset($data['dimension_ids']) ? $data['dimension_ids'] : null;
        ...
        $this->container['matrix_product'] = isset($data['matrix_product']) ? $data['matrix_product'] : null;
    }
    ...
    {
        return $this->container['dimension_ids'];
    }

    /**
     * Sets dimension_ids
     * @param int[] $dimension_ids up to 3 dimensions. If you want to specify only 2nd or 3rd dimension, leave the first and/or second as 0
     * @return $this
     */
    public function setDimensionIds($dimension_ids)
    {
        $this->container['dimension_ids'] = $dimension_ids;
     ...
     * @param bool $generate_code2_automatically if true, the product code2 will be generated based on the user configuration or will generate the conde in case there is none
     * @return $this
     */
    ...
    {
        return $this->container['matrix_product'];
    }

    /**
     * Sets matrix_product
     * @param \Swagger\Client\Model\ProductsProductRequest $matrix_product Matrix product can have up to 3 dimensions
     * @return $this
     */
    public function setMatrixProduct($matrix_product)
    {
        $this->container['matrix_product'] = $matrix_product;
