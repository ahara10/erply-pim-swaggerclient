<?php
/**
 * PermissionsSetUserPermissionRequest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * PermissionsSetUserPermissionRequest Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PermissionsSetUserPermissionRequest implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'permissions.SetUserPermissionRequest';
    ...
    protected static $attributeMap = array(
        'is_create_enabled' => 'isCreateEnabled',
    ...
    protected static $setters = array(
        'is_create_enabled' => 'setIsCreateEnabled',
        'is_delete_enabled' => 'setIsDeleteEnabled',
        'is_update_enabled' => 'setIsUpdateEnabled',
        'user_id' => 'setUserId'
    );
    ...
    protected static $getters = array(
        'is_create_enabled' => 'getIsCreateEnabled',
        'is_delete_enabled' => 'getIsDeleteEnabled',
        'is_update_enabled' => 'getIsUpdateEnabled',
        'user_id' => 'getUserId'
    );
    ...
    {
        $this->container['is_create_enabled'] = isset($data['is_create_enabled']) ? $data['is_create_enabled'] : null;
        $this->container['is_delete_enabled'] = isset($data['is_delete_enabled']) ? $data['is_delete_enabled'] : null;
        $this->container['is_update_enabled'] = isset($data['is_update_enabled']) ? $data['is_update_enabled'] : null;
    ...
    /**
     * Gets is_create_enabled
     * @return bool
     */
    public function getIsCreateEnabled()
    {
        return $this->container['is_create_enabled'];
    }

    /**
     * Sets is_create_enabled
     * @param bool $is_create_enabled
     * @return $this
     */
    public function setIsCreateEnabled($is_create_enabled)
    {
        $this->container['is_create_enabled'] = $is_create_enabled;

        return $this;
    }

    /**
     * Gets is_delete_enabled
     * @return bool
     */
    public function getIsDeleteEnabled()
    {
        return $this->container['is_delete_enabled'];
    }

    /**
     * Sets is_delete_enabled
     * @param bool $is_delete_enabled
     * @return $this
     */
    public function setIsDeleteEnabled($is_delete_enabled)
    {
        $this->container['is_delete_enabled'] = $is_delete_enabled;

        return $this;
    }

    /**
     * Gets is_update_enabled
     * @return bool
     */
    public function getIsUpdateEnabled()
    {
        return $this->container['is_update_enabled'];
    }

    /**
     * Sets is_update_enabled
     * @param bool $is_update_enabled
     * @return $this
     */
    public function setIsUpdateEnabled($is_update_enabled)
    {
        $this->container['is_update_enabled'] = $is_update_enabled;
