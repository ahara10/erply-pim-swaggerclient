<?php
/**
 * ProductsBulkPatchUpdateProductRequestItem
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * ProductsBulkPatchUpdateProductRequestItem Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ProductsBulkPatchUpdateProductRequestItem implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'products.BulkPatchUpdateProductRequestItem';
    ...
    /**
     * Sets resource_id
     * @param int $resource_id The resourceId request field should be used for the product id in each request for the bulk update.
     * @return $this
     */
