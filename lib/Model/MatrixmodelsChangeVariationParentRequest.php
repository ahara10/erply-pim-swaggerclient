<?php
/**
 * MatrixmodelsChangeVariationParentRequest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * MatrixmodelsChangeVariationParentRequest Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class MatrixmodelsChangeVariationParentRequest implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'matrixmodels.ChangeVariationParentRequest';
