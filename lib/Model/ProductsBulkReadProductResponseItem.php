<?php
/**
 * ProductsBulkReadProductResponseItem
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * ProductsBulkReadProductResponseItem Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ProductsBulkReadProductResponseItem implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'products.BulkReadProductResponseItem';
    ...
    /**
     * Sets result_id
     * @param int $result_id id of the response item
     * @return $this
     */
