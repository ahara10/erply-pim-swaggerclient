<?php
/**
 * RequestsParameterOptionRequest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * RequestsParameterOptionRequest Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class RequestsParameterOptionRequest implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'requests.ParameterOptionRequest';
    ...
    /**
     * Sets name
     * @param \Swagger\Client\Model\CommonmodelsTranslatable $name Names translations
     * @return $this
     */
    ...
    /**
     * Sets parameter_id
     * @param int $parameter_id for parameter options
     * @return $this
     */
