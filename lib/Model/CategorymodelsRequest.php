...
/**
 * CategorymodelsRequest Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CategorymodelsRequest implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'categorymodels.Request';
    ...
    /**
     * Sets main_id
     * @param int $main_id ParentID Refers to the parent category — product categories are hierarchical.
     * @return $this
     */
