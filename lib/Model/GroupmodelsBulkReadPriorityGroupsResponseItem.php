<?php
/**
 * GroupmodelsBulkReadPriorityGroupsResponseItem
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * GroupmodelsBulkReadPriorityGroupsResponseItem Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GroupmodelsBulkReadPriorityGroupsResponseItem implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'groupmodels.BulkReadPriorityGroupsResponseItem';
    ...
    protected static $swaggerTypes = array(
        'message' => 'string',
        'priority_groups' => '\Swagger\Client\Model\GroupmodelsPriorityGroupResponse[]',
        'result_id' => 'int',
        'total_count' => 'int'
    );
    ...
    protected static $setters = array(
        'message' => 'setMessage',
        'priority_groups' => 'setPriorityGroups',
    ...
    protected static $getters = array(
        'message' => 'getMessage',
        'priority_groups' => 'getPriorityGroups',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['priority_groups'] = isset($data['priority_groups']) ? $data['priority_groups'] : null;
    ...
    /**
     * Gets priority_groups
     * @return \Swagger\Client\Model\GroupmodelsPriorityGroupResponse[]
     */
    public function getPriorityGroups()
    {
        return $this->container['priority_groups'];
    }

    /**
     * Sets priority_groups
     * @param \Swagger\Client\Model\GroupmodelsPriorityGroupResponse[] $priority_groups
     * @return $this
     */
    public function setPriorityGroups($priority_groups)
    {
        $this->container['priority_groups'] = $priority_groups;
    ...
    /**
     * Sets result_id
     * @param int $result_id id of the response, if requested 3 read requests each ID represents 1 response item
     * @return $this
     */
    ...
    /**
     * Sets total_count
     * @param int $total_count total number of records (ignores skip & take parameters)
     * @return $this
     */
