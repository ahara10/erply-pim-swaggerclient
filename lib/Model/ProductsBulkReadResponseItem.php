...
/**
 * ProductsBulkReadResponseItem Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ProductsBulkReadResponseItem implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'products.BulkReadResponseItem';
    ...
    protected static $swaggerTypes = array(
        'error' => 'string',
        'product_id' => 'int',
        'results' => '\Swagger\Client\Model\LinkedproductmodelsResponse[]'
    );
    ...
    /**
     * Sets results
     * @param \Swagger\Client\Model\LinkedproductmodelsResponse[] $results
     * @return $this
     */
