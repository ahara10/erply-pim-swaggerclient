...
/**
 * ProductsBulkCreateProductRequestItem Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ProductsBulkCreateProductRequestItem implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'products.BulkCreateProductRequestItem';
     ...
     * @param bool $generate_code2_automatically if true, the product code will be generated based on the user configuration or will generate the code in case there is none
     * @return $this
     */
     ...
     * @param bool $generate_code_automatically if true, the product code will be generated based on the user configuration or will generate the code in case there is none
     * @return $this
     */
