...
/**
 * ModelsMoveRequest Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ModelsMoveRequest implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'models.MoveRequest';
    ...
    /**
     * Sets position
     * @param string $position Position has to be  lastChild | before | after
     * @return $this
     */
    ...
    /**
     * Sets target_id
     * @param int $target_id Target ID represents the object that the requested object is put after, or before, or becomes the last child of
     * @return $this
     */
