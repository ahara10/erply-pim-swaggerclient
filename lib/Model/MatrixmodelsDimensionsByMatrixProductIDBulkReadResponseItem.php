<?php
/**
 * MatrixmodelsDimensionsByMatrixProductIDBulkReadResponseItem
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * MatrixmodelsDimensionsByMatrixProductIDBulkReadResponseItem Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class MatrixmodelsDimensionsByMatrixProductIDBulkReadResponseItem implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'matrixmodels.DimensionsByMatrixProductIDBulkReadResponseItem';
    ...
    /**
     * Sets resource_id
     * @param int $resource_id matrix product ID
     * @return $this
     */
