<?php
/**
 * FamilymodelsBulkReadResponseItem
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * FamilymodelsBulkReadResponseItem Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class FamilymodelsBulkReadResponseItem implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'familymodels.BulkReadResponseItem';
    ...
    protected static $swaggerTypes = array(
        'families' => '\Swagger\Client\Model\FamilymodelsResponse[]',
        'message' => 'string',
        'result_id' => 'int'
    );
    ...
    /**
     * Sets families
     * @param \Swagger\Client\Model\FamilymodelsResponse[] $families
     * @return $this
     */
