<?php
/**
 * GroupmodelsPriorityGroupCreateRequest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * GroupmodelsPriorityGroupCreateRequest Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GroupmodelsPriorityGroupCreateRequest implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'groupmodels.PriorityGroupCreateRequest';
