...
/**
 * BrandmodelsBulkResponseItem Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class BrandmodelsBulkResponseItem implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'brandmodels.BulkResponseItem';
    ...
    protected static $swaggerTypes = array(
        'brands' => '\Swagger\Client\Model\BrandmodelsResponse[]',
        'message' => 'string',
        'result_id' => 'int'
    );
    ...
    /**
     * Sets brands
     * @param \Swagger\Client\Model\BrandmodelsResponse[] $brands
     * @return $this
     */
