...
/**
 * IndentationResult Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class IndentationResult implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'indentation.Result';
    ...
    /**
     * Sets name
     * @param string $name The name is the name in the client's default language. Will be prefixed n times if the element is a child of another element.
     * @return $this
     */
