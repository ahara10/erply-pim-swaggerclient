<?php
/**
 * MatrixmodelsDimensionBulkReadResponseItem
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * MatrixmodelsDimensionBulkReadResponseItem Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class MatrixmodelsDimensionBulkReadResponseItem implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'matrixmodels.DimensionBulkReadResponseItem';
    ...
    protected static $swaggerTypes = array(
        'dimensions' => '\Swagger\Client\Model\MatrixmodelsDimensionResponse[]',
        'message' => 'string',
        'result_id' => 'int'
    );
    ...
    /**
     * Sets dimensions
     * @param \Swagger\Client\Model\MatrixmodelsDimensionResponse[] $dimensions
     * @return $this
     */
