...
/**
 * ParametermodelsValidationRuleRequest Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ParametermodelsValidationRuleRequest implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'parametermodels.ValidationRuleRequest';
    ...
    /**
     * Sets type
     * @param string $type Type of the validation rule. Can be REQUIRED, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE, INPUT_CASE and PRECISION
     * @return $this
     */
