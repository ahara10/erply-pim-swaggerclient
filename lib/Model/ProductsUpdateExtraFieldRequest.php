<?php
/**
 * ProductsUpdateExtraFieldRequest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * ProductsUpdateExtraFieldRequest Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ProductsUpdateExtraFieldRequest implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'products.UpdateExtraFieldRequest';
    ...
    /**
     * Sets code
     * @param string $code code of the extra field
     * @return $this
     */
    ...
    /**
     * Sets is_active
     * @param bool $is_active Is the field active?
     * @return $this
     */
