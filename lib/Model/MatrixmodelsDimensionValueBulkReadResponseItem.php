<?php
/**
 * MatrixmodelsDimensionValueBulkReadResponseItem
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * MatrixmodelsDimensionValueBulkReadResponseItem Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class MatrixmodelsDimensionValueBulkReadResponseItem implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'matrixmodels.DimensionValueBulkReadResponseItem';
    ...
    protected static $swaggerTypes = array(
        'dimension_values' => '\Swagger\Client\Model\MatrixmodelsDimensionValueResponse[]',
        'message' => 'string',
        'result_id' => 'int',
        'total_count' => 'int'
    );
     ...
     * @param \Swagger\Client\Model\MatrixmodelsDimensionValueResponse[] $dimension_values
     * @return $this
     */
