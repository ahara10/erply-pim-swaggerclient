<?php
/**
 * RecipemodelsBulkReadResponseItem
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * RecipemodelsBulkReadResponseItem Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class RecipemodelsBulkReadResponseItem implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'recipemodels.BulkReadResponseItem';
    ...
    protected static $swaggerTypes = array(
        'message' => 'string',
        'recipes' => '\Swagger\Client\Model\RecipemodelsResponse[]',
        'result_id' => 'int',
        'total_count' => 'int'
    );
    ...
    /**
     * Sets recipes
     * @param \Swagger\Client\Model\RecipemodelsResponse[] $recipes
     * @return $this
     */
