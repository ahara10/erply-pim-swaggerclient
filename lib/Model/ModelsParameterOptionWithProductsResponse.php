<?php
/**
 * ModelsParameterOptionWithProductsResponse
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * ModelsParameterOptionWithProductsResponse Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ModelsParameterOptionWithProductsResponse implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'models.ParameterOptionWithProductsResponse';
    ...
    protected static $swaggerTypes = array(
        'parameter_option' => '\Swagger\Client\Model\ParametermodelsOptionResponse',
        'products' => '\Swagger\Client\Model\ProductsProductResponse[]'
    );
    ...
    protected static $setters = array(
        'parameter_option' => 'setParameterOption',
    ...
    protected static $getters = array(
        'parameter_option' => 'getParameterOption',
    ...
    {
        $this->container['parameter_option'] = isset($data['parameter_option']) ? $data['parameter_option'] : null;
    ...
    /**
     * Gets parameter_option
     * @return \Swagger\Client\Model\ParametermodelsOptionResponse
     */
    public function getParameterOption()
    {
        return $this->container['parameter_option'];
    }

    /**
     * Sets parameter_option
     * @param \Swagger\Client\Model\ParametermodelsOptionResponse $parameter_option
     * @return $this
     */
    public function setParameterOption($parameter_option)
    {
        $this->container['parameter_option'] = $parameter_option;
    ...
    /**
     * Sets products
     * @param \Swagger\Client\Model\ProductsProductResponse[] $products
     * @return $this
     */
