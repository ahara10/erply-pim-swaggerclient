<?php
/**
 * MatrixmodelsProductBulkReadResponseItem
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * MatrixmodelsProductBulkReadResponseItem Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class MatrixmodelsProductBulkReadResponseItem implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'matrixmodels.ProductBulkReadResponseItem';
