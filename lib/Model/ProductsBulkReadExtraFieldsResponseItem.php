...
/**
 * ProductsBulkReadExtraFieldsResponseItem Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ProductsBulkReadExtraFieldsResponseItem implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'products.BulkReadExtraFieldsResponseItem';
    ...
    protected static $swaggerTypes = array(
        'extra_fields' => '\Swagger\Client\Model\ProductsExtraFieldResponse[]',
        'message' => 'string',
        'result_id' => 'int',
        'total_count' => 'int'
    );
    ...
    /**
     * Sets extra_fields
     * @param \Swagger\Client\Model\ProductsExtraFieldResponse[] $extra_fields
     * @return $this
     */
