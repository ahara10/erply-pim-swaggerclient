...
/**
 * ProductsCreateUpdateAutoCodes Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ProductsCreateUpdateAutoCodes implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'products.CreateUpdateAutoCodes';
    ...
    protected static $setters = array(
        'next_code' => 'setNextCode',
        'next_code2' => 'setNextCode2'
    );
    ...
    {
        $this->container['next_code'] = isset($data['next_code']) ? $data['next_code'] : null;
        $this->container['next_code2'] = isset($data['next_code2']) ? $data['next_code2'] : null;
    }
    ...
    {
        return $this->container['next_code'];
    }
    ...
    {
        $this->container['next_code'] = $next_code;
     ...
     * @return int
     */
    public function getNextCode2()
    {
        return $this->container['next_code2'];
    }

    /**
     * Sets next_code2
     * @param int $next_code2
     * @return $this
     */
    public function setNextCode2($next_code2)
    {
        $this->container['next_code2'] = $next_code2;
