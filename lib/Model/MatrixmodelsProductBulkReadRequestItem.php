<?php
/**
 * MatrixmodelsProductBulkReadRequestItem
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * MatrixmodelsProductBulkReadRequestItem Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class MatrixmodelsProductBulkReadRequestItem implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'matrixmodels.ProductBulkReadRequestItem';
    ...
    protected static $attributeMap = array(
        'matrix_product_ids' => 'matrix_product_ids',
    ...
    protected static $setters = array(
        'matrix_product_ids' => 'setMatrixProductIds',
    ...
    protected static $getters = array(
        'matrix_product_ids' => 'getMatrixProductIds',
    ...
    {
        $this->container['matrix_product_ids'] = isset($data['matrix_product_ids']) ? $data['matrix_product_ids'] : null;
    ...
    /**
     * Gets matrix_product_ids
     * @return int[]
     */
    public function getMatrixProductIds()
    {
        return $this->container['matrix_product_ids'];
    }

    /**
     * Sets matrix_product_ids
     * @param int[] $matrix_product_ids Expected usage: API client has a matrix product ID and wants to get a complete list of variations. Format: 1 or many matrix product IDs.
     * @return $this
     */
    public function setMatrixProductIds($matrix_product_ids)
    {
        $this->container['matrix_product_ids'] = $matrix_product_ids;
    ...
    /**
     * Sets product_ids
     * @param int[] $product_ids Expected usage: API client will get a bunch of products from GET /v1/product and will want to fetch variation descriptions for the same items. Format: 1 or many product IDs.
     * @return $this
     */
