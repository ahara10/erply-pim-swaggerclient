...
/**
 * ResponsesBulkResult Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ResponsesBulkResult implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'responses.BulkResult';
    ...
    /**
     * Sets resource_id
     * @param int $resource_id identifier of the REST-ful response
     * @return $this
     */
    ...
    /**
     * Sets result_id
     * @param int $result_id identifier of the result item
     * @return $this
     */
