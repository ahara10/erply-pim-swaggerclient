...
/**
 * PackagesPackageResponse Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PackagesPackageResponse implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'packages.PackageResponse';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['package_category_id'] = isset($data['package_category_id']) ? $data['package_category_id'] : null;
    ...
    /**
     * Sets code
     * @param string $code To be used if the package has a different code than the product itself.
     * @return $this
     */
     ...
     * @param int $package_category_id Package Category ID
     * @return $this
     */
    ...
    /**
     * Sets units
     * @param float $units Size of the package (how many pcs it contains)
     * @return $this
     */
