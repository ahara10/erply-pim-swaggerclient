<?php
/**
 * IndentationCategoryTreeResultSampleNoChildren
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * IndentationCategoryTreeResultSampleNoChildren Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class IndentationCategoryTreeResultSampleNoChildren implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'indentation.CategoryTreeResultSampleNoChildren';
