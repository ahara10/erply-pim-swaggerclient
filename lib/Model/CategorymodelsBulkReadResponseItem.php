<?php
/**
 * CategorymodelsBulkReadResponseItem
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CategorymodelsBulkReadResponseItem Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CategorymodelsBulkReadResponseItem implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'categorymodels.BulkReadResponseItem';
    ...
    protected static $swaggerTypes = array(
        'categories' => '\Swagger\Client\Model\CategorymodelsResponse[]',
        'message' => 'string',
        'result_id' => 'int',
        'total_count' => 'int'
    );
    ...
    /**
     * Sets categories
     * @param \Swagger\Client\Model\CategorymodelsResponse[] $categories
     * @return $this
     */
