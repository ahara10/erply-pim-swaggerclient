<?php
/**
 * GroupmodelsLocationSpecificTaxRequest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * GroupmodelsLocationSpecificTaxRequest Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GroupmodelsLocationSpecificTaxRequest implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'groupmodels.LocationSpecificTaxRequest';
    ...
    {
        $this->container['taxrate_id'] = isset($data['taxrate_id']) ? $data['taxrate_id'] : null;
    ...
    {
        return $this->container['taxrate_id'];
    }

    /**
     * Sets taxrate_id
     * @param int $taxrate_id
     * @return $this
     */
    public function setTaxrateId($taxrate_id)
    {
        $this->container['taxrate_id'] = $taxrate_id;
