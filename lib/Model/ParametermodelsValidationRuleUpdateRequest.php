<?php
/**
 * ParametermodelsValidationRuleUpdateRequest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * ParametermodelsValidationRuleUpdateRequest Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ParametermodelsValidationRuleUpdateRequest implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'parametermodels.ValidationRuleUpdateRequest';
