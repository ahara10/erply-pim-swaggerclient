<?php
/**
 * MatrixmodelsCreateVariationRequest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * MatrixmodelsCreateVariationRequest Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class MatrixmodelsCreateVariationRequest implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'matrixmodels.CreateVariationRequest';
