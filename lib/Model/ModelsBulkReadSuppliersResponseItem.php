<?php
/**
 * ModelsBulkReadSuppliersResponseItem
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * ModelsBulkReadSuppliersResponseItem Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ModelsBulkReadSuppliersResponseItem implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'models.BulkReadSuppliersResponseItem';
    ...
    protected static $swaggerTypes = array(
        'message' => 'string',
        'result_id' => 'int',
        'suppliers' => '\Swagger\Client\Model\ModelsSupplierResponse[]',
        'total_count' => 'int'
    );
    ...
    /**
     * Sets suppliers
     * @param \Swagger\Client\Model\ModelsSupplierResponse[] $suppliers
     * @return $this
     */
