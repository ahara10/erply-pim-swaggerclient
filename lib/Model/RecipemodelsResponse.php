...
/**
 * RecipemodelsResponse Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class RecipemodelsResponse implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'recipemodels.Response';
    ...
    protected static $swaggerTypes = array(
        ...
        'changed' => 'int',
        'changedby' => 'string',
        'component_product' => '\Swagger\Client\Model\ProductsProductResponse',
        'id' => 'int',
        'order' => 'int',
        'product' => '\Swagger\Client\Model\ProductsProductResponse',
        'product_id' => 'int',
        'product_id_component' => 'int'
    );
    ...
    protected static $attributeMap = array(
        ...
        'product_id_component' => 'product_id_component'
    );
    ...
    protected static $setters = array(
        ...
        'component_product' => 'setComponentProduct',
        'id' => 'setId',
        'order' => 'setOrder',
        'product' => 'setProduct',
        'product_id' => 'setProductId',
        'product_id_component' => 'setProductIdComponent'
    );
    ...
    protected static $getters = array(
        ...
        'component_product' => 'getComponentProduct',
        'id' => 'getId',
        'order' => 'getOrder',
        'product' => 'getProduct',
        'product_id' => 'getProductId',
        'product_id_component' => 'getProductIdComponent'
    );
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['component_product'] = isset($data['component_product']) ? $data['component_product'] : null;
        $this->container['id'] = isset($data['id']) ? $data['id'] : null;
        $this->container['order'] = isset($data['order']) ? $data['order'] : null;
        $this->container['product'] = isset($data['product']) ? $data['product'] : null;
        $this->container['product_id'] = isset($data['product_id']) ? $data['product_id'] : null;
        $this->container['product_id_component'] = isset($data['product_id_component']) ? $data['product_id_component'] : null;
    }
    ...
    /**
     * Gets component_product
     * @return \Swagger\Client\Model\ProductsProductResponse
     */
    public function getComponentProduct()
    {
        return $this->container['component_product'];
    }

    /**
     * Sets component_product
     * @param \Swagger\Client\Model\ProductsProductResponse $component_product
     * @return $this
     */
    public function setComponentProduct($component_product)
    {
        $this->container['component_product'] = $component_product;
    ...
    /**
     * Sets product
     * @param \Swagger\Client\Model\ProductsProductResponse $product
     * @return $this
     */
    ...
    /**
     * Gets product_id_component
     * @return int
     */
    public function getProductIdComponent()
    {
        return $this->container['product_id_component'];
    }

    /**
     * Sets product_id_component
     * @param int $product_id_component
     * @return $this
     */
    public function setProductIdComponent($product_id_component)
    {
        $this->container['product_id_component'] = $product_id_component;
