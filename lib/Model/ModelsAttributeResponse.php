...
/**
 * ModelsAttributeResponse Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ModelsAttributeResponse implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'models.AttributeResponse';
    ...
    /**
     * Sets entity
     * @param string $entity Entity name of the record
     * @return $this
     */
    ...
    /**
     * Sets record_id
     * @param int $record_id ID of the database record
     * @return $this
     */
    ...
    /**
     * Sets type
     * @param string $type 3 types are available - int, double, text
     * @return $this
     */
