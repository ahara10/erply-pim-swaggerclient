<?php
/**
 * GroupmodelsBulkReadGroupsResponseItem
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * GroupmodelsBulkReadGroupsResponseItem Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GroupmodelsBulkReadGroupsResponseItem implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'groupmodels.BulkReadGroupsResponseItem';
    ...
    protected static $swaggerTypes = array(
        'groups' => '\Swagger\Client\Model\GroupmodelsGroupResponse[]',
        'message' => 'string',
        'result_id' => 'int',
        'total_count' => 'int'
    );
    ...
    /**
     * Sets groups
     * @param \Swagger\Client\Model\GroupmodelsGroupResponse[] $groups
     * @return $this
     */
