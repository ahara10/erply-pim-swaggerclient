<?php
/**
 * LinkedproductmodelsCreateRequest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * LinkedproductmodelsCreateRequest Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class LinkedproductmodelsCreateRequest implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'linkedproductmodels.CreateRequest';
    ...
    protected static $setters = array(
        'linked_product_id' => 'setLinkedProductId',
    ...
    protected static $getters = array(
        'linked_product_id' => 'getLinkedProductId',
    ...
    {
        $this->container['linked_product_id'] = isset($data['linked_product_id']) ? $data['linked_product_id'] : null;
    ...
    /**
     * Gets linked_product_id
     * @return int
     */
    public function getLinkedProductId()
    {
        return $this->container['linked_product_id'];
    }

    /**
     * Sets linked_product_id
     * @param int $linked_product_id
     * @return $this
     */
    public function setLinkedProductId($linked_product_id)
    {
        $this->container['linked_product_id'] = $linked_product_id;
    ...
    /**
     * Sets type
     * @param string $type Link type can be cross-sell or substitute
     * @return $this
     */
