...
/**
 * ProductParameterSetApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   http://github.com/swagger-api/swagger-codegen
...
class ProductParameterSetApi
{
    ...
    /**
     * Operation v1ProductParameterSetGet
     *
     * Get Parameter Sets
     *
     * @param int $skip skip n records (optional)
     * @param int $take items to take, default: 20, max: 100000 (optional)
     * @return \Swagger\Client\Model\ModelsSetResponse[]
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductParameterSetGet($skip = null, $take = null)
    {
        list($response) = $this->v1ProductParameterSetGetWithHttpInfo($skip, $take);
        return $response;
    }

    /**
     * Operation v1ProductParameterSetGetWithHttpInfo
     *
     * Get Parameter Sets
     *
     * @param int $skip skip n records (optional)
     * @param int $take items to take, default: 20, max: 100000 (optional)
     * @return Array of \Swagger\Client\Model\ModelsSetResponse[], HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductParameterSetGetWithHttpInfo($skip = null, $take = null)
    {
        // parse inputs
        $resourcePath = "/v1/product/parameter/set";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ModelsSetResponse[]',
                '/v1/product/parameter/set'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ModelsSetResponse[]', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ModelsSetResponse[]', $e->getResponseHeaders());
    ...
    /**
     * Operation v1ProductParameterSetIdPut
     *
     * Update Set's Name
     *
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductParameterSetIdPut($name, $id)
    {
        list($response) = $this->v1ProductParameterSetIdPutWithHttpInfo($name, $id);
        return $response;
    }

    /**
     * Operation v1ProductParameterSetIdPutWithHttpInfo
     *
     * Update Set's Name
     *
     * @param \Swagger\Client\Model\RequestsRequest $name Name (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductParameterSetIdPutWithHttpInfo($name, $id)
    {
        // verify the required parameter 'name' is set
        if ($name === null) {
            throw new \InvalidArgumentException('Missing the required parameter $name when calling v1ProductParameterSetIdPut');
        }
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling v1ProductParameterSetIdPut');
        }
        // parse inputs
        $resourcePath = "/v1/product/parameter/set/{id}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    /**
     * Operation v1ProductParameterSetIdsDelete
     *
     * Delete Parameter Sets
     *
     * @param string $ids up to 100 semicolon delimited set IDs (required)
     * @return \Swagger\Client\Model\ResponsesResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductParameterSetIdsDelete($ids)
    {
        list($response) = $this->v1ProductParameterSetIdsDeleteWithHttpInfo($ids);
        return $response;
    }

    /**
     * Operation v1ProductParameterSetIdsDeleteWithHttpInfo
     *
     * Delete Parameter Sets
     *
     * @param string $ids up to 100 semicolon delimited set IDs (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductParameterSetIdsDeleteWithHttpInfo($ids)
    {
        // verify the required parameter 'ids' is set
        if ($ids === null) {
            throw new \InvalidArgumentException('Missing the required parameter $ids when calling v1ProductParameterSetIdsDelete');
        }
        // parse inputs
        $resourcePath = "/v1/product/parameter/set/{ids}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    /**
     * Operation v1ProductParameterSetPost
     *
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductParameterSetPost($name)
    {
        list($response) = $this->v1ProductParameterSetPostWithHttpInfo($name);
        return $response;
    }

    /**
     * Operation v1ProductParameterSetPostWithHttpInfo
     *
     * Create Parameter Set
     *
     * @param \Swagger\Client\Model\RequestsRequest $name Name (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductParameterSetPostWithHttpInfo($name)
    {
        // verify the required parameter 'name' is set
        if ($name === null) {
            throw new \InvalidArgumentException('Missing the required parameter $name when calling v1ProductParameterSetPost');
        }
        // parse inputs
        $resourcePath = "/v1/product/parameter/set";
        $httpBody = '';
