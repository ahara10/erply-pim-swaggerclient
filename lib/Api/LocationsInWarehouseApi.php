...
/**
 * LocationsInWarehouseApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   http://github.com/swagger-api/swagger-codegen
...
class LocationsInWarehouseApi
{
     ...
     *
     * @return LocationsInWarehouseApi
     */
    ...
    /**
     * Operation v1WarehouseLocationsGet
     *
     ...
     * @return \Swagger\Client\Model\WarehousesLocationJSON[]
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1WarehouseLocationsGet($skip = null, $take = null, $sort = null, $filter = null)
    {
        list($response) = $this->v1WarehouseLocationsGetWithHttpInfo($skip, $take, $sort, $filter);
        return $response;
    }

    /**
     * Operation v1WarehouseLocationsGetWithHttpInfo
     *
     * Read Locations in warehouse
     *
     * @param int $skip skip n records (optional)
     ...
     * @param string $sort the sort parameter is explained in the &#x60;Filtering &amp; Sorting&#x60; section on top of the Swagger documentation (optional)
     * @param string $filter the filter parameter is explained in the &#x60;Filtering &amp; Sorting&#x60; section on top of the Swagger documentation (optional)
     * @return Array of \Swagger\Client\Model\WarehousesLocationJSON[], HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1WarehouseLocationsGetWithHttpInfo($skip = null, $take = null, $sort = null, $filter = null)
    {
        // parse inputs
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\WarehousesLocationJSON[]',
                '/v1/warehouse/locations'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\WarehousesLocationJSON[]', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\WarehousesLocationJSON[]', $e->getResponseHeaders());
