...
/**
 * ProductUnitsApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   http://github.com/swagger-api/swagger-codegen
...
class ProductUnitsApi
{
    ...
    /**
     * Operation v1ProductUnitBulkGetPost
     *
     * Get units in bulk
     *
     ...
     * @return \Swagger\Client\Model\ProductsBulkReadUnitsResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductUnitBulkGetPost($request)
    {
        list($response) = $this->v1ProductUnitBulkGetPostWithHttpInfo($request);
        return $response;
    }

    /**
     * Operation v1ProductUnitBulkGetPostWithHttpInfo
     *
     * Get units in bulk
     *
     * @param \Swagger\Client\Model\ParammodelsBulkReadRequest $request requests have the parameters that the original get request has, but in json format. This way you can apply the parameters to each request separately. (required)
     * @return Array of \Swagger\Client\Model\ProductsBulkReadUnitsResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductUnitBulkGetPostWithHttpInfo($request)
    {
        // verify the required parameter 'request' is set
        if ($request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling v1ProductUnitBulkGetPost');
        }
        // parse inputs
        $resourcePath = "/v1/product/unit/bulk/get";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ProductsBulkReadUnitsResponse',
                '/v1/product/unit/bulk/get'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ProductsBulkReadUnitsResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ProductsBulkReadUnitsResponse', $e->getResponseHeaders());
    ...
    /**
     * Operation v1ProductUnitBulkPost
     *
     * Create units in bulk
     *
     * @param \Swagger\Client\Model\ProductsBulkCreateUnitsRequest $request bulk create request (required)
     * @return \Swagger\Client\Model\ResponsesBulkResponseWithResults
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductUnitBulkPost($request)
    {
        list($response) = $this->v1ProductUnitBulkPostWithHttpInfo($request);
        return $response;
    }

    /**
     * Operation v1ProductUnitBulkPostWithHttpInfo
     *
     * Create units in bulk
     *
     * @param \Swagger\Client\Model\ProductsBulkCreateUnitsRequest $request bulk create request (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductUnitBulkPostWithHttpInfo($request)
    {
        // verify the required parameter 'request' is set
        if ($request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling v1ProductUnitBulkPost');
        }
        // parse inputs
        $resourcePath = "/v1/product/unit/bulk";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
     ...
     * @return \Swagger\Client\Model\ProductsUnitResponse[]
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductUnitGet($skip = null, $take = null, $sort = null, $filter = null)
    {
        list($response) = $this->v1ProductUnitGetWithHttpInfo($skip, $take, $sort, $filter);
        return $response;
    }

    /**
     * Operation v1ProductUnitGetWithHttpInfo
     *
     * Get Units
     *
     * @param int $skip skip n records (optional)
     ...
     * @param string $sort the sort parameter is explained in the &#x60;Filtering &amp; Sorting&#x60; section on top of the Swagger documentation (optional)
     * @param string $filter the filter parameter is explained in the &#x60;Filtering &amp; Sorting&#x60; section on top of the Swagger documentation (optional)
     * @return Array of \Swagger\Client\Model\ProductsUnitResponse[], HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductUnitGetWithHttpInfo($skip = null, $take = null, $sort = null, $filter = null)
    {
        // parse inputs
        $resourcePath = "/v1/product/unit";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ProductsUnitResponse[]',
                '/v1/product/unit'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ProductsUnitResponse[]', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ProductsUnitResponse[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
    ...
    /**
     * Operation v1ProductUnitIdMovePut
     *
     * Move Product Unit
     *
     * @param int $id Product Unit ID (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductUnitIdMovePut($id, $move_request)
    {
        list($response) = $this->v1ProductUnitIdMovePutWithHttpInfo($id, $move_request);
        return $response;
    }

    /**
     * Operation v1ProductUnitIdMovePutWithHttpInfo
     *
     * Move Product Unit
     *
     * @param int $id Product Unit ID (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductUnitIdMovePutWithHttpInfo($id, $move_request)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling v1ProductUnitIdMovePut');
        }
        // verify the required parameter 'move_request' is set
        if ($move_request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $move_request when calling v1ProductUnitIdMovePut');
        }
        // parse inputs
        $resourcePath = "/v1/product/unit/{id}/move";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    /**
     * Operation v1ProductUnitIdPut
     *
     * Update a Product Unit
     *
     * @param \Swagger\Client\Model\ProductsUnitRequest $request request (required)
     * @param int $id Product Unit ID (required)
     * @return \Swagger\Client\Model\ResponsesResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductUnitIdPut($request, $id)
    {
        list($response) = $this->v1ProductUnitIdPutWithHttpInfo($request, $id);
        return $response;
    }

    /**
     * Operation v1ProductUnitIdPutWithHttpInfo
     *
     * Update a Product Unit
     *
     * @param \Swagger\Client\Model\ProductsUnitRequest $request request (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductUnitIdPutWithHttpInfo($request, $id)
    {
        // verify the required parameter 'request' is set
        if ($request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling v1ProductUnitIdPut');
        }
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling v1ProductUnitIdPut');
        }
        // parse inputs
        $resourcePath = "/v1/product/unit/{id}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    /**
     * Operation v1ProductUnitIdsDelete
     *
     * Delete Product Units
     *
     * @param string $ids up to 100 semicolon delimited Product Unit IDs (required)
     * @return \Swagger\Client\Model\ResponsesResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductUnitIdsDelete($ids)
    {
        list($response) = $this->v1ProductUnitIdsDeleteWithHttpInfo($ids);
        return $response;
    }

    /**
     * Operation v1ProductUnitIdsDeleteWithHttpInfo
     *
     * Delete Product Units
     *
     * @param string $ids up to 100 semicolon delimited Product Unit IDs (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductUnitIdsDeleteWithHttpInfo($ids)
    {
        // verify the required parameter 'ids' is set
        if ($ids === null) {
            throw new \InvalidArgumentException('Missing the required parameter $ids when calling v1ProductUnitIdsDelete');
        }
        // parse inputs
        $resourcePath = "/v1/product/unit/{ids}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductUnitPost($request)
    {
        list($response) = $this->v1ProductUnitPostWithHttpInfo($request);
        return $response;
    }

    /**
     * Operation v1ProductUnitPostWithHttpInfo
     *
     * Create a Product Unit
     *
     * @param \Swagger\Client\Model\ProductsUnitRequest $request request (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductUnitPostWithHttpInfo($request)
    {
        // verify the required parameter 'request' is set
        if ($request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling v1ProductUnitPost');
        }
        // parse inputs
        $resourcePath = "/v1/product/unit";
        $httpBody = '';
