...
/**
 * ParameterSetToGroupLinkingApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   http://github.com/swagger-api/swagger-codegen
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ParameterSetToGroupLinkingApi
{
     ...
     *
     * @return ParameterSetToGroupLinkingApi
     */
    ...
    /**
     * Operation v1ProductParameterSetGroupsIdsDelete
     *
     ...
     */
    public function v1ProductParameterSetGroupsIdsDelete($ids)
    {
        list($response) = $this->v1ProductParameterSetGroupsIdsDeleteWithHttpInfo($ids);
        return $response;
    }

    /**
     * Operation v1ProductParameterSetGroupsIdsDeleteWithHttpInfo
     *
     * Delete Linked Groups
     *
     * @param string $ids up to 100 semicolon delimited link IDs (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductParameterSetGroupsIdsDeleteWithHttpInfo($ids)
    {
        // verify the required parameter 'ids' is set
        if ($ids === null) {
            throw new \InvalidArgumentException('Missing the required parameter $ids when calling v1ProductParameterSetGroupsIdsDelete');
        }
        // parse inputs
        $resourcePath = "/v1/product/parameter/set/groups/{ids}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                '/v1/product/parameter/set/groups/{ids}'
            );
    ...
    /**
     * Operation v1ProductParameterSetIdGroupsGet
     *
     * Get Linked Groups
     *
     * @param int $id set ID (required)
     * @param int $skip skip n records (optional)
     * @param int $take amount to take (optional)
     * @return \Swagger\Client\Model\ModelsSetToGroupResponse[]
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductParameterSetIdGroupsGet($id, $skip = null, $take = null)
    {
        list($response) = $this->v1ProductParameterSetIdGroupsGetWithHttpInfo($id, $skip, $take);
        return $response;
    }

    /**
     * Operation v1ProductParameterSetIdGroupsGetWithHttpInfo
     *
     * Get Linked Groups
     *
     * @param int $id set ID (required)
     * @param int $skip skip n records (optional)
     * @param int $take amount to take (optional)
     * @return Array of \Swagger\Client\Model\ModelsSetToGroupResponse[], HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductParameterSetIdGroupsGetWithHttpInfo($id, $skip = null, $take = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling v1ProductParameterSetIdGroupsGet');
        }
        // parse inputs
        $resourcePath = "/v1/product/parameter/set/{id}/groups";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ModelsSetToGroupResponse[]',
                '/v1/product/parameter/set/{id}/groups'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ModelsSetToGroupResponse[]', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ModelsSetToGroupResponse[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ResponsesMessageResponse', $e->getResponseHeaders());
    ...
    /**
     * Operation v1ProductParameterSetIdGroupsPost
     *
     * Link Group
     *
     * @param int $id set ID (required)
     * @param \Swagger\Client\Model\RequestsIDRequest $id2 group ID (required)
     * @return \Swagger\Client\Model\ResponsesMessageResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductParameterSetIdGroupsPost($id, $id2)
    {
        list($response) = $this->v1ProductParameterSetIdGroupsPostWithHttpInfo($id, $id2);
        return $response;
    }

    /**
     * Operation v1ProductParameterSetIdGroupsPostWithHttpInfo
     *
     * Link Group
     *
     * @param int $id set ID (required)
     * @param \Swagger\Client\Model\RequestsIDRequest $id2 group ID (required)
     * @return Array of \Swagger\Client\Model\ResponsesMessageResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductParameterSetIdGroupsPostWithHttpInfo($id, $id2)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling v1ProductParameterSetIdGroupsPost');
        }
        // verify the required parameter 'id2' is set
        if ($id2 === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id2 when calling v1ProductParameterSetIdGroupsPost');
        }
        // parse inputs
        $resourcePath = "/v1/product/parameter/set/{id}/groups";
        $httpBody = '';
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ResponsesMessageResponse',
                '/v1/product/parameter/set/{id}/groups'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ResponsesMessageResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ResponsesMessageResponse', $e->getResponseHeaders());
