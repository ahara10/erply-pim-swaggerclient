...
class BrandApi
{
     ...
     * @return \Swagger\Client\Model\BrandmodelsBulkResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1BrandBulkGetPost($request)
    {
        list($response) = $this->v1BrandBulkGetPostWithHttpInfo($request);
        return $response;
    }

    /**
     * Operation v1BrandBulkGetPostWithHttpInfo
     *
     * Get brands in bulk
     *
     * @param \Swagger\Client\Model\ParammodelsBulkReadRequestNoTotalCount $request requests have the parameters that the original get request has, but in json format. This way you can apply the parameters to each request separately. (required)
     * @return Array of \Swagger\Client\Model\BrandmodelsBulkResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1BrandBulkGetPostWithHttpInfo($request)
    {
        // verify the required parameter 'request' is set
        if ($request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling v1BrandBulkGetPost');
        }
        // parse inputs
        $resourcePath = "/v1/brand/bulk/get";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\BrandmodelsBulkResponse',
                '/v1/brand/bulk/get'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\BrandmodelsBulkResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\BrandmodelsBulkResponse', $e->getResponseHeaders());
    ...
    /**
     * Operation v1BrandBulkPost
     *
     * Create brands in bulk
     *
     * @param \Swagger\Client\Model\BrandmodelsBulkCreateRequest $request bulk create request (required)
     * @return \Swagger\Client\Model\ResponsesBulkResponseWithResults
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1BrandBulkPost($request)
    {
        list($response) = $this->v1BrandBulkPostWithHttpInfo($request);
        return $response;
    }

    /**
     * Operation v1BrandBulkPostWithHttpInfo
     *
     * Create brands in bulk
     *
     * @param \Swagger\Client\Model\BrandmodelsBulkCreateRequest $request bulk create request (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1BrandBulkPostWithHttpInfo($request)
    {
        // verify the required parameter 'request' is set
        if ($request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling v1BrandBulkPost');
        }
        // parse inputs
        $resourcePath = "/v1/brand/bulk";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
     ...
     * @return \Swagger\Client\Model\BrandmodelsResponse[]
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1BrandGet($skip = null, $take = null, $sort = null, $filter = null)
    {
        list($response) = $this->v1BrandGetWithHttpInfo($skip, $take, $sort, $filter);
        return $response;
    }

    /**
     * Operation v1BrandGetWithHttpInfo
     *
     * Get brands
     *
     * @param int $skip skip n records (optional)
     ...
     * @param string $sort the sort parameter is explained in the &#x60;Filtering &amp; Sorting&#x60; section on top of the Swagger documentation (optional)
     * @param string $filter the filter parameter is explained in the &#x60;Filtering &amp; Sorting&#x60; section on top of the Swagger documentation (optional)
     * @return Array of \Swagger\Client\Model\BrandmodelsResponse[], HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1BrandGetWithHttpInfo($skip = null, $take = null, $sort = null, $filter = null)
    {
        // parse inputs
        $resourcePath = "/v1/brand";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\BrandmodelsResponse[]',
                '/v1/brand'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\BrandmodelsResponse[]', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\BrandmodelsResponse[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
    ...
    /**
     * Operation v1BrandIdPut
     *
     * Update brand
     *
     * @param \Swagger\Client\Model\BrandmodelsRequest $brand_request brandRequest (required)
     * @param int $id brand ID (required)
     * @return \Swagger\Client\Model\ResponsesResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1BrandIdPut($brand_request, $id)
    {
        list($response) = $this->v1BrandIdPutWithHttpInfo($brand_request, $id);
        return $response;
    }

    /**
     * Operation v1BrandIdPutWithHttpInfo
     *
     * Update brand
     *
     * @param \Swagger\Client\Model\BrandmodelsRequest $brand_request brandRequest (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1BrandIdPutWithHttpInfo($brand_request, $id)
    {
        // verify the required parameter 'brand_request' is set
        if ($brand_request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $brand_request when calling v1BrandIdPut');
        }
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling v1BrandIdPut');
        }
        // parse inputs
        $resourcePath = "/v1/brand/{id}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    /**
     * Operation v1BrandIdsDelete
     *
     * Delete brands
     *
     * @param string $ids up to 100 semicolon delimited brand IDs (required)
     * @return \Swagger\Client\Model\ResponsesResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1BrandIdsDelete($ids)
    {
        list($response) = $this->v1BrandIdsDeleteWithHttpInfo($ids);
        return $response;
    }

    /**
     * Operation v1BrandIdsDeleteWithHttpInfo
     *
     * Delete brands
     *
     * @param string $ids up to 100 semicolon delimited brand IDs (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1BrandIdsDeleteWithHttpInfo($ids)
    {
        // verify the required parameter 'ids' is set
        if ($ids === null) {
            throw new \InvalidArgumentException('Missing the required parameter $ids when calling v1BrandIdsDelete');
        }
        // parse inputs
        $resourcePath = "/v1/brand/{ids}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    /**
     * Operation v1BrandPost
     *
     * Create brand
     *
     * @param \Swagger\Client\Model\BrandmodelsRequest $brand_request Name (required)
     * @return \Swagger\Client\Model\ResponsesResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1BrandPost($brand_request)
    {
        list($response) = $this->v1BrandPostWithHttpInfo($brand_request);
        return $response;
    }

    /**
     * Operation v1BrandPostWithHttpInfo
     *
     * Create brand
     *
     * @param \Swagger\Client\Model\BrandmodelsRequest $brand_request Name (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1BrandPostWithHttpInfo($brand_request)
    {
        // verify the required parameter 'brand_request' is set
        if ($brand_request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $brand_request when calling v1BrandPost');
        }
        // parse inputs
        $resourcePath = "/v1/brand";
        $httpBody = '';
