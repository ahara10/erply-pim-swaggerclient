...
/**
 * ProductPackageApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   http://github.com/swagger-api/swagger-codegen
...
class ProductPackageApi
{
    ...
    /**
     * Operation v1ProductPackageCategoryGet
     *
     ...
     * @return \Swagger\Client\Model\PackagesPackageCategoryResponse[]
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductPackageCategoryGet($skip = null, $take = null, $sort = null, $filter = null)
    {
        list($response) = $this->v1ProductPackageCategoryGetWithHttpInfo($skip, $take, $sort, $filter);
        return $response;
    }

    /**
     * Operation v1ProductPackageCategoryGetWithHttpInfo
     *
     * Get Package Categories
     *
     * @param int $skip skip n records (optional)
     ...
     * @param string $sort the sort parameter is explained in the &#x60;Filtering &amp; Sorting&#x60; section on top of the Swagger documentation (optional)
     * @param string $filter the filter parameter is explained in the &#x60;Filtering &amp; Sorting&#x60; section on top of the Swagger documentation (optional)
     * @return Array of \Swagger\Client\Model\PackagesPackageCategoryResponse[], HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductPackageCategoryGetWithHttpInfo($skip = null, $take = null, $sort = null, $filter = null)
    {
        // parse inputs
        $resourcePath = "/v1/product/package/category";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\PackagesPackageCategoryResponse[]',
                '/v1/product/package/category'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\PackagesPackageCategoryResponse[]', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\PackagesPackageCategoryResponse[]', $e->getResponseHeaders());
     ...
     * @param string $sort the sort parameter is explained in the &#x60;Filtering &amp; Sorting&#x60; section on top of the Swagger documentation (optional)
     * @param string $filter the filter parameter is explained in the &#x60;Filtering &amp; Sorting&#x60; section on top of the Swagger documentation (optional)
     * @return \Swagger\Client\Model\PackagesPackageResponse[]
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductPackageGet($skip = null, $take = null, $sort = null, $filter = null)
    {
        list($response) = $this->v1ProductPackageGetWithHttpInfo($skip, $take, $sort, $filter);
        return $response;
    }

    /**
     * Operation v1ProductPackageGetWithHttpInfo
     *
     * Get Packages
     *
     * @param int $skip skip n records (optional)
     ...
     * @param string $sort the sort parameter is explained in the &#x60;Filtering &amp; Sorting&#x60; section on top of the Swagger documentation (optional)
     * @param string $filter the filter parameter is explained in the &#x60;Filtering &amp; Sorting&#x60; section on top of the Swagger documentation (optional)
     * @return Array of \Swagger\Client\Model\PackagesPackageResponse[], HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductPackageGetWithHttpInfo($skip = null, $take = null, $sort = null, $filter = null)
    {
        // parse inputs
        $resourcePath = "/v1/product/package";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\PackagesPackageResponse[]',
                '/v1/product/package'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\PackagesPackageResponse[]', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\PackagesPackageResponse[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ResponsesMessageResponse', $e->getResponseHeaders());
    ...
    /**
     * Operation v1ProductPackageIdPut
     *
     * Update Package
     *
     * @param int $id package ID (required)
     * @param \Swagger\Client\Model\PackagesPackageUpdateRequest $package package (required)
     * @return \Swagger\Client\Model\ResponsesResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductPackageIdPut($id, $package)
    {
        list($response) = $this->v1ProductPackageIdPutWithHttpInfo($id, $package);
        return $response;
    }

    /**
     * Operation v1ProductPackageIdPutWithHttpInfo
     *
     * Update Package
     *
     * @param int $id package ID (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductPackageIdPutWithHttpInfo($id, $package)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling v1ProductPackageIdPut');
        }
        // verify the required parameter 'package' is set
        if ($package === null) {
            throw new \InvalidArgumentException('Missing the required parameter $package when calling v1ProductPackageIdPut');
        }
        // parse inputs
        $resourcePath = "/v1/product/package/{id}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    /**
     * Operation v1ProductPackageIdsDelete
     *
     * Delete Packages
     *
     * @param string $ids up to 100 semicolon delimited package IDs (required)
     * @return \Swagger\Client\Model\ResponsesResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductPackageIdsDelete($ids)
    {
        list($response) = $this->v1ProductPackageIdsDeleteWithHttpInfo($ids);
        return $response;
    }

    /**
     * Operation v1ProductPackageIdsDeleteWithHttpInfo
     *
     * Delete Packages
     *
     * @param string $ids up to 100 semicolon delimited package IDs (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductPackageIdsDeleteWithHttpInfo($ids)
    {
        // verify the required parameter 'ids' is set
        if ($ids === null) {
            throw new \InvalidArgumentException('Missing the required parameter $ids when calling v1ProductPackageIdsDelete');
        }
        // parse inputs
        $resourcePath = "/v1/product/package/{ids}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    /**
     * Operation v1ProductPackagePost
     *
     * Create Package
     *
     * @param \Swagger\Client\Model\PackagesPackageRequest $package package (required)
     * @return \Swagger\Client\Model\ResponsesResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductPackagePost($package)
    {
        list($response) = $this->v1ProductPackagePostWithHttpInfo($package);
        return $response;
    }

    /**
     * Operation v1ProductPackagePostWithHttpInfo
     *
     * Create Package
     *
     * @param \Swagger\Client\Model\PackagesPackageRequest $package package (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductPackagePostWithHttpInfo($package)
    {
        // verify the required parameter 'package' is set
        if ($package === null) {
            throw new \InvalidArgumentException('Missing the required parameter $package when calling v1ProductPackagePost');
        }
        // parse inputs
        $resourcePath = "/v1/product/package";
        $httpBody = '';
