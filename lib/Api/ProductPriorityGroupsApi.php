...
/**
 * ProductPriorityGroupsApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   http://github.com/swagger-api/swagger-codegen
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProductPriorityGroupsApi
{
     ...
     *
     * @return ProductPriorityGroupsApi
     */
    ...
    /**
     * Operation v1ProductPriorityGroupBulkGetPost
     *
     ...
     * @return \Swagger\Client\Model\GroupmodelsBulkReadPriorityGroupsResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductPriorityGroupBulkGetPost($request)
    {
        list($response) = $this->v1ProductPriorityGroupBulkGetPostWithHttpInfo($request);
        return $response;
    }

    /**
     * Operation v1ProductPriorityGroupBulkGetPostWithHttpInfo
     *
     * Get priority groups in bulk
     *
     * @param \Swagger\Client\Model\ParammodelsBulkReadRequest $request requests have the parameters that the original get request has, but in json format. This way you can apply the parameters to each request separately. (required)
     * @return Array of \Swagger\Client\Model\GroupmodelsBulkReadPriorityGroupsResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductPriorityGroupBulkGetPostWithHttpInfo($request)
    {
        // verify the required parameter 'request' is set
        if ($request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling v1ProductPriorityGroupBulkGetPost');
        }
        // parse inputs
        $resourcePath = "/v1/product/priority/group/bulk/get";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\GroupmodelsBulkReadPriorityGroupsResponse',
                '/v1/product/priority/group/bulk/get'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\GroupmodelsBulkReadPriorityGroupsResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\GroupmodelsBulkReadPriorityGroupsResponse', $e->getResponseHeaders());
    ...
    /**
     * Operation v1ProductPriorityGroupBulkPost
     *
     * Create priority groups in bulk
     *
     * @param \Swagger\Client\Model\GroupmodelsBulkCreatePriorityGroupRequest $request bulk create request (required)
     * @return \Swagger\Client\Model\ResponsesBulkResponseWithResults
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductPriorityGroupBulkPost($request)
    {
        list($response) = $this->v1ProductPriorityGroupBulkPostWithHttpInfo($request);
        return $response;
    }

    /**
     * Operation v1ProductPriorityGroupBulkPostWithHttpInfo
     *
     * Create priority groups in bulk
     *
     * @param \Swagger\Client\Model\GroupmodelsBulkCreatePriorityGroupRequest $request bulk create request (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductPriorityGroupBulkPostWithHttpInfo($request)
    {
        // verify the required parameter 'request' is set
        if ($request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling v1ProductPriorityGroupBulkPost');
        }
        // parse inputs
        $resourcePath = "/v1/product/priority/group/bulk";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                '/v1/product/priority/group/bulk'
            );
    ...
    /**
     * Operation v1ProductPriorityGroupGet
     *
     ...
     * @return \Swagger\Client\Model\GroupmodelsPriorityGroupResponse[]
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductPriorityGroupGet($skip = null, $take = null, $sort = null, $filter = null)
    {
        list($response) = $this->v1ProductPriorityGroupGetWithHttpInfo($skip, $take, $sort, $filter);
        return $response;
    }

    /**
     * Operation v1ProductPriorityGroupGetWithHttpInfo
     *
     * Read Priority Groups
     *
     * @param int $skip skip n records (optional)
     ...
     * @param string $sort the sort parameter is explained in the &#x60;Filtering &amp; Sorting&#x60; section on top of the Swagger documentation (optional)
     * @param string $filter the filter parameter is explained in the &#x60;Filtering &amp; Sorting&#x60; section on top of the Swagger documentation (optional)
     * @return Array of \Swagger\Client\Model\GroupmodelsPriorityGroupResponse[], HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductPriorityGroupGetWithHttpInfo($skip = null, $take = null, $sort = null, $filter = null)
    {
        // parse inputs
        $resourcePath = "/v1/product/priority/group";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\GroupmodelsPriorityGroupResponse[]',
                '/v1/product/priority/group'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\GroupmodelsPriorityGroupResponse[]', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\GroupmodelsPriorityGroupResponse[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
    ...
    /**
     * Operation v1ProductPriorityGroupIdMovePut
     *
     * Move Priority Group
     *
     * @param int $id priority group ID (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductPriorityGroupIdMovePut($id, $move_request)
    {
        list($response) = $this->v1ProductPriorityGroupIdMovePutWithHttpInfo($id, $move_request);
        return $response;
    }

    /**
     * Operation v1ProductPriorityGroupIdMovePutWithHttpInfo
     *
     * Move Priority Group
     *
     * @param int $id priority group ID (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductPriorityGroupIdMovePutWithHttpInfo($id, $move_request)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling v1ProductPriorityGroupIdMovePut');
        }
        // verify the required parameter 'move_request' is set
        if ($move_request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $move_request when calling v1ProductPriorityGroupIdMovePut');
        }
        // parse inputs
        $resourcePath = "/v1/product/priority/group/{id}/move";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                '/v1/product/priority/group/{id}/move'
            );
    ...
    /**
     * Operation v1ProductPriorityGroupIdPut
     *
     * Update a Priority Group
     *
     * @param \Swagger\Client\Model\GroupmodelsPriorityGroupCreateRequest $request request (required)
     * @param int $id priority group ID (required)
     * @return \Swagger\Client\Model\ResponsesResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductPriorityGroupIdPut($request, $id)
    {
        list($response) = $this->v1ProductPriorityGroupIdPutWithHttpInfo($request, $id);
        return $response;
    }

    /**
     * Operation v1ProductPriorityGroupIdPutWithHttpInfo
     *
     * Update a Priority Group
     *
     * @param \Swagger\Client\Model\GroupmodelsPriorityGroupCreateRequest $request request (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductPriorityGroupIdPutWithHttpInfo($request, $id)
    {
        // verify the required parameter 'request' is set
        if ($request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling v1ProductPriorityGroupIdPut');
        }
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling v1ProductPriorityGroupIdPut');
        }
        // parse inputs
        $resourcePath = "/v1/product/priority/group/{id}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    /**
     * Operation v1ProductPriorityGroupIdsDelete
     *
     * Delete Priority Groups
     *
     * @param string $ids up to 100 semicolon delimited priority group IDs (required)
     * @return \Swagger\Client\Model\ResponsesResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductPriorityGroupIdsDelete($ids)
    {
        list($response) = $this->v1ProductPriorityGroupIdsDeleteWithHttpInfo($ids);
        return $response;
    }

    /**
     * Operation v1ProductPriorityGroupIdsDeleteWithHttpInfo
     *
     * Delete Priority Groups
     *
     * @param string $ids up to 100 semicolon delimited priority group IDs (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductPriorityGroupIdsDeleteWithHttpInfo($ids)
    {
        // verify the required parameter 'ids' is set
        if ($ids === null) {
            throw new \InvalidArgumentException('Missing the required parameter $ids when calling v1ProductPriorityGroupIdsDelete');
        }
        // parse inputs
        $resourcePath = "/v1/product/priority/group/{ids}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    /**
     * Operation v1ProductPriorityGroupPost
     *
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductPriorityGroupPost($request)
    {
        list($response) = $this->v1ProductPriorityGroupPostWithHttpInfo($request);
        return $response;
    }

    /**
     * Operation v1ProductPriorityGroupPostWithHttpInfo
     *
     * Create a Priority Group
     *
     * @param \Swagger\Client\Model\GroupmodelsPriorityGroupCreateRequest $request request (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductPriorityGroupPostWithHttpInfo($request)
    {
        // verify the required parameter 'request' is set
        if ($request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling v1ProductPriorityGroupPost');
        }
        // parse inputs
        $resourcePath = "/v1/product/priority/group";
        $httpBody = '';
