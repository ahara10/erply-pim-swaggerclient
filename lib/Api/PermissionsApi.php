...
class PermissionsApi
{
    ...
    /**
     * Operation v1PermissionsPatch
     *
     * Set / Update a permission
     *
     * @param string $entity values: &#39;product group&#39; or &#39;product category&#39; (required)
     * @param \Swagger\Client\Model\PermissionsSetUserPermissionRequest $request request (required)
     * @return \Swagger\Client\Model\ResponsesResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1PermissionsPatch($entity, $request)
    {
        list($response) = $this->v1PermissionsPatchWithHttpInfo($entity, $request);
        return $response;
    }

    /**
     * Operation v1PermissionsPatchWithHttpInfo
     *
     * Set / Update a permission
     *
     * @param string $entity values: &#39;product group&#39; or &#39;product category&#39; (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1PermissionsPatchWithHttpInfo($entity, $request)
    {
        // verify the required parameter 'entity' is set
        if ($entity === null) {
            throw new \InvalidArgumentException('Missing the required parameter $entity when calling v1PermissionsPatch');
        }
        // verify the required parameter 'request' is set
        if ($request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling v1PermissionsPatch');
        }
        // parse inputs
        ...
        // query params
        if ($entity !== null) {
            $queryParams['entity'] = $this->apiClient->getSerializer()->toQueryValue($entity);
        }
    ...
    /**
     * Operation v1PermissionsUserIDGet
     *
     * Get user permissions
     *
     * @param int $user_id user ID (required)
     * @param string $entity values: &#39;product group&#39; or &#39;product category&#39; (required)
     * @return \Swagger\Client\Model\PermissionsUserPermission
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1PermissionsUserIDGet($user_id, $entity)
    {
        list($response) = $this->v1PermissionsUserIDGetWithHttpInfo($user_id, $entity);
        return $response;
    }

    /**
     * Operation v1PermissionsUserIDGetWithHttpInfo
     *
     * Get user permissions
     *
     * @param int $user_id user ID (required)
     * @param string $entity values: &#39;product group&#39; or &#39;product category&#39; (required)
     * @return Array of \Swagger\Client\Model\PermissionsUserPermission, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1PermissionsUserIDGetWithHttpInfo($user_id, $entity)
    {
        // verify the required parameter 'user_id' is set
        if ($user_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $user_id when calling v1PermissionsUserIDGet');
        }
        // verify the required parameter 'entity' is set
        if ($entity === null) {
            throw new \InvalidArgumentException('Missing the required parameter $entity when calling v1PermissionsUserIDGet');
        }
        // parse inputs
        $resourcePath = "/v1/permissions/{userID}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\PermissionsUserPermission',
                '/v1/permissions/{userID}'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\PermissionsUserPermission', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\PermissionsUserPermission', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ResponsesMessageResponse', $e->getResponseHeaders());
