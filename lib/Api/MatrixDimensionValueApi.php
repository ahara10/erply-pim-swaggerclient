...
/**
 * MatrixDimensionValueApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   http://github.com/swagger-api/swagger-codegen
...
class MatrixDimensionValueApi
{
     ...
     *
     * @return MatrixDimensionValueApi
     */
    ...
    /**
     * Operation v1MatrixDimensionValueBulkGetPost
     *
     * Get dimension values in bulk
     *
     * @param \Swagger\Client\Model\ParammodelsBulkReadRequestNoTotalCount $request requests have the parameters that the original get request has, but in json format. This way you can apply the parameters to each request separately. (required)
     * @return \Swagger\Client\Model\MatrixmodelsDimensionValueBulkReadResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1MatrixDimensionValueBulkGetPost($request)
    {
        list($response) = $this->v1MatrixDimensionValueBulkGetPostWithHttpInfo($request);
        return $response;
    }

    /**
     * Operation v1MatrixDimensionValueBulkGetPostWithHttpInfo
     *
     * Get dimension values in bulk
     *
     * @param \Swagger\Client\Model\ParammodelsBulkReadRequestNoTotalCount $request requests have the parameters that the original get request has, but in json format. This way you can apply the parameters to each request separately. (required)
     * @return Array of \Swagger\Client\Model\MatrixmodelsDimensionValueBulkReadResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1MatrixDimensionValueBulkGetPostWithHttpInfo($request)
    {
        // verify the required parameter 'request' is set
        if ($request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling v1MatrixDimensionValueBulkGetPost');
        }
        // parse inputs
        $resourcePath = "/v1/matrix/dimension/value/bulk/get";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\MatrixmodelsDimensionValueBulkReadResponse',
                '/v1/matrix/dimension/value/bulk/get'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\MatrixmodelsDimensionValueBulkReadResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\MatrixmodelsDimensionValueBulkReadResponse', $e->getResponseHeaders());
    ...
    /**
     * Operation v1MatrixDimensionValueBulkPost
     *
     * Create dimension values in bulk
     *
     * @param \Swagger\Client\Model\MatrixmodelsDimensionValueBulkCreateRequest $request bulk create request (required)
     * @return \Swagger\Client\Model\ResponsesBulkResponseWithResults
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1MatrixDimensionValueBulkPost($request)
    {
        list($response) = $this->v1MatrixDimensionValueBulkPostWithHttpInfo($request);
        return $response;
    }

    /**
     * Operation v1MatrixDimensionValueBulkPostWithHttpInfo
     *
     * Create dimension values in bulk
     *
     * @param \Swagger\Client\Model\MatrixmodelsDimensionValueBulkCreateRequest $request bulk create request (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1MatrixDimensionValueBulkPostWithHttpInfo($request)
    {
        // verify the required parameter 'request' is set
        if ($request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling v1MatrixDimensionValueBulkPost');
        }
        // parse inputs
        $resourcePath = "/v1/matrix/dimension/value/bulk";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                '/v1/matrix/dimension/value/bulk'
            );
    ...
    /**
     * Operation v1MatrixDimensionValueGet
     *
     ...
     * @return \Swagger\Client\Model\MatrixmodelsDimensionValueResponse[]
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1MatrixDimensionValueGet($skip = null, $take = null, $sort = null, $filter = null, $with_total_count = null)
    {
        list($response) = $this->v1MatrixDimensionValueGetWithHttpInfo($skip, $take, $sort, $filter, $with_total_count);
        return $response;
    }

    /**
     * Operation v1MatrixDimensionValueGetWithHttpInfo
     *
     * Get Matrix Dimension Values
     *
     * @param int $skip skip n records (optional)
     ...
     * @param string $filter the filter parameter is explained in the &#x60;Filtering &amp; Sorting&#x60; section on top of the Swagger documentation (optional)
     * @param bool $with_total_count optionally return total number of records in the X-Total-Count response header (optional)
     * @return Array of \Swagger\Client\Model\MatrixmodelsDimensionValueResponse[], HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1MatrixDimensionValueGetWithHttpInfo($skip = null, $take = null, $sort = null, $filter = null, $with_total_count = null)
    {
        // parse inputs
        $resourcePath = "/v1/matrix/dimension/value";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\MatrixmodelsDimensionValueResponse[]',
                '/v1/matrix/dimension/value'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\MatrixmodelsDimensionValueResponse[]', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\MatrixmodelsDimensionValueResponse[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
    ...
    /**
     * Operation v1MatrixDimensionValueIdMovePut
     *
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1MatrixDimensionValueIdMovePut($id, $move_request)
    {
        list($response) = $this->v1MatrixDimensionValueIdMovePutWithHttpInfo($id, $move_request);
        return $response;
    }

    /**
     * Operation v1MatrixDimensionValueIdMovePutWithHttpInfo
     *
     * Move Dimension Value
     *
     * @param int $id ID (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1MatrixDimensionValueIdMovePutWithHttpInfo($id, $move_request)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling v1MatrixDimensionValueIdMovePut');
        }
        // verify the required parameter 'move_request' is set
        if ($move_request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $move_request when calling v1MatrixDimensionValueIdMovePut');
        }
        // parse inputs
        $resourcePath = "/v1/matrix/dimension/value/{id}/move";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                '/v1/matrix/dimension/value/{id}/move'
            );
    ...
    /**
     * Operation v1MatrixDimensionValueIdPut
     *
     * Update Matrix Dimension Value
     *
     * @param int $id dimension value ID (required)
     * @param \Swagger\Client\Model\MatrixmodelsDimensionValueUpdateRequest $dimension_value_request DimensionValueRequest (required)
     * @return \Swagger\Client\Model\ResponsesResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1MatrixDimensionValueIdPut($id, $dimension_value_request)
    {
        list($response) = $this->v1MatrixDimensionValueIdPutWithHttpInfo($id, $dimension_value_request);
        return $response;
    }

    /**
     * Operation v1MatrixDimensionValueIdPutWithHttpInfo
     *
     * Update Matrix Dimension Value
     *
     * @param int $id dimension value ID (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1MatrixDimensionValueIdPutWithHttpInfo($id, $dimension_value_request)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling v1MatrixDimensionValueIdPut');
        }
        // verify the required parameter 'dimension_value_request' is set
        if ($dimension_value_request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $dimension_value_request when calling v1MatrixDimensionValueIdPut');
        }
        // parse inputs
        $resourcePath = "/v1/matrix/dimension/value/{id}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        // body params
        $_tempBody = null;
        if (isset($dimension_value_request)) {
            $_tempBody = $dimension_value_request;
        }
    ...
    /**
     * Operation v1MatrixDimensionValueIdsDelete
     *
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1MatrixDimensionValueIdsDelete($ids)
    {
        list($response) = $this->v1MatrixDimensionValueIdsDeleteWithHttpInfo($ids);
        return $response;
    }

    /**
     * Operation v1MatrixDimensionValueIdsDeleteWithHttpInfo
     *
     * Delete Matrix Dimension Values if not used by any active product
     *
     * @param string $ids up to 100 semicolon delimited IDs (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1MatrixDimensionValueIdsDeleteWithHttpInfo($ids)
    {
        // verify the required parameter 'ids' is set
        if ($ids === null) {
            throw new \InvalidArgumentException('Missing the required parameter $ids when calling v1MatrixDimensionValueIdsDelete');
        }
        // parse inputs
        $resourcePath = "/v1/matrix/dimension/value/{ids}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    /**
     * Operation v1MatrixDimensionValuePost
     *
     * Create Matrix Dimension Value
     *
     * @param \Swagger\Client\Model\MatrixmodelsDimensionValueRequest $matrix_dimension_value_request matrixDimensionValueRequest (required)
     * @return \Swagger\Client\Model\ResponsesResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1MatrixDimensionValuePost($matrix_dimension_value_request)
    {
        list($response) = $this->v1MatrixDimensionValuePostWithHttpInfo($matrix_dimension_value_request);
        return $response;
    }

    /**
     * Operation v1MatrixDimensionValuePostWithHttpInfo
     *
     * Create Matrix Dimension Value
     *
     * @param \Swagger\Client\Model\MatrixmodelsDimensionValueRequest $matrix_dimension_value_request matrixDimensionValueRequest (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1MatrixDimensionValuePostWithHttpInfo($matrix_dimension_value_request)
    {
        // verify the required parameter 'matrix_dimension_value_request' is set
        if ($matrix_dimension_value_request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $matrix_dimension_value_request when calling v1MatrixDimensionValuePost');
        }
        // parse inputs
        $resourcePath = "/v1/matrix/dimension/value";
        $httpBody = '';
        ...
        // body params
        $_tempBody = null;
        if (isset($matrix_dimension_value_request)) {
            $_tempBody = $matrix_dimension_value_request;
        }
