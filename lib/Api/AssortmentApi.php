...
class AssortmentApi
{
    ...
    /**
     * Operation v1AssortmentGet
     *
     * Get Assortments
     *
     * @param int $skip skip n records (optional)
     * @param int $take items to take, default: 20, max: 100000 (optional)
     * @return \Swagger\Client\Model\ModelsAssortmentResponse[]
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1AssortmentGet($skip = null, $take = null)
    {
        list($response) = $this->v1AssortmentGetWithHttpInfo($skip, $take);
        return $response;
    }

    /**
     * Operation v1AssortmentGetWithHttpInfo
     *
     * Get Assortments
     *
     * @param int $skip skip n records (optional)
     * @param int $take items to take, default: 20, max: 100000 (optional)
     * @return Array of \Swagger\Client\Model\ModelsAssortmentResponse[], HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1AssortmentGetWithHttpInfo($skip = null, $take = null)
    {
        // parse inputs
        $resourcePath = "/v1/assortment";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ModelsAssortmentResponse[]',
                '/v1/assortment'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ModelsAssortmentResponse[]', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ModelsAssortmentResponse[]', $e->getResponseHeaders());
    ...
    /**
     * Operation v1AssortmentIdPut
     *
     * Update Assortment
     *
     * @param \Swagger\Client\Model\ModelsAssortmentRequest $assortment_request AssortmentRequest (required)
     * @param int $id Assortment ID (required)
     * @return \Swagger\Client\Model\ResponsesResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1AssortmentIdPut($assortment_request, $id)
    {
        list($response) = $this->v1AssortmentIdPutWithHttpInfo($assortment_request, $id);
        return $response;
    }

    /**
     * Operation v1AssortmentIdPutWithHttpInfo
     *
     * Update Assortment
     *
     * @param \Swagger\Client\Model\ModelsAssortmentRequest $assortment_request AssortmentRequest (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1AssortmentIdPutWithHttpInfo($assortment_request, $id)
    {
        // verify the required parameter 'assortment_request' is set
        if ($assortment_request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $assortment_request when calling v1AssortmentIdPut');
        }
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling v1AssortmentIdPut');
        }
        // parse inputs
        $resourcePath = "/v1/assortment/{id}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    /**
     * Operation v1AssortmentIdsDelete
     *
     * Delete Assortments & the related links to products and products.
     *
     * @param string $ids up to 100 semicolon delimited assortment ids (required)
     * @return \Swagger\Client\Model\ResponsesResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1AssortmentIdsDelete($ids)
    {
        list($response) = $this->v1AssortmentIdsDeleteWithHttpInfo($ids);
        return $response;
    }

    /**
     * Operation v1AssortmentIdsDeleteWithHttpInfo
     *
     * Delete Assortments & the related links to products and products.
     *
     * @param string $ids up to 100 semicolon delimited assortment ids (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1AssortmentIdsDeleteWithHttpInfo($ids)
    {
        // verify the required parameter 'ids' is set
        if ($ids === null) {
            throw new \InvalidArgumentException('Missing the required parameter $ids when calling v1AssortmentIdsDelete');
        }
        // parse inputs
        $resourcePath = "/v1/assortment/{ids}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    /**
     * Operation v1AssortmentPost
     *
     * Create Assortment
     *
     * @param \Swagger\Client\Model\ModelsAssortmentRequest $assortment_request Name and code (required)
     * @return \Swagger\Client\Model\ResponsesResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1AssortmentPost($assortment_request)
    {
        list($response) = $this->v1AssortmentPostWithHttpInfo($assortment_request);
        return $response;
    }

    /**
     * Operation v1AssortmentPostWithHttpInfo
     *
     * Create Assortment
     *
     * @param \Swagger\Client\Model\ModelsAssortmentRequest $assortment_request Name and code (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1AssortmentPostWithHttpInfo($assortment_request)
    {
        // verify the required parameter 'assortment_request' is set
        if ($assortment_request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $assortment_request when calling v1AssortmentPost');
        }
        // parse inputs
        $resourcePath = "/v1/assortment";
        $httpBody = '';
