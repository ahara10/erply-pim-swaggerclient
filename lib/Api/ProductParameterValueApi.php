...
/**
 * ProductParameterValueApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   http://github.com/swagger-api/swagger-codegen
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProductParameterValueApi
{
     ...
     *
     * @return ProductParameterValueApi
     */
    ...
    /**
     * Operation v1ProductIdsParameterValueGet
     *
     ...
     * @return \Swagger\Client\Model\ParametermodelsValueResponse[]
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductIdsParameterValueGet($ids, $skip = null, $take = null)
    {
        list($response) = $this->v1ProductIdsParameterValueGetWithHttpInfo($ids, $skip, $take);
        return $response;
    }

    /**
     * Operation v1ProductIdsParameterValueGetWithHttpInfo
     *
     * Get Product Parameter Values by Product IDs
     *
     * @param string $ids can contain up to 100 semicolon delimited ids. (required)
     * @param int $skip skip n records (optional)
     * @param int $take items to take, default: 20, max: 100000 (optional)
     * @return Array of \Swagger\Client\Model\ParametermodelsValueResponse[], HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductIdsParameterValueGetWithHttpInfo($ids, $skip = null, $take = null)
    {
        // verify the required parameter 'ids' is set
        if ($ids === null) {
            throw new \InvalidArgumentException('Missing the required parameter $ids when calling v1ProductIdsParameterValueGet');
        }
        // parse inputs
        $resourcePath = "/v1/product/{ids}/parameter/value";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ParametermodelsValueResponse[]',
                '/v1/product/{ids}/parameter/value'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ParametermodelsValueResponse[]', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ParametermodelsValueResponse[]', $e->getResponseHeaders());
    ...
    /**
     * Operation v1ProductParameterValueIdPut
     *
     * Update Product Parameter Value
     *
     * @param \Swagger\Client\Model\RequestsValueRequest $value Parameter Value (required)
     * @param int $id value ID (required)
     * @param bool $apply_validation_rules Apply-Validation-Rules flag (required)
     * @return \Swagger\Client\Model\ResponsesResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductParameterValueIdPut($value, $id, $apply_validation_rules)
    {
        list($response) = $this->v1ProductParameterValueIdPutWithHttpInfo($value, $id, $apply_validation_rules);
        return $response;
    }

    /**
     * Operation v1ProductParameterValueIdPutWithHttpInfo
     *
     * Update Product Parameter Value
     *
     * @param \Swagger\Client\Model\RequestsValueRequest $value Parameter Value (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductParameterValueIdPutWithHttpInfo($value, $id, $apply_validation_rules)
    {
        // verify the required parameter 'value' is set
        if ($value === null) {
            throw new \InvalidArgumentException('Missing the required parameter $value when calling v1ProductParameterValueIdPut');
        }
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling v1ProductParameterValueIdPut');
        }
        // verify the required parameter 'apply_validation_rules' is set
        if ($apply_validation_rules === null) {
            throw new \InvalidArgumentException('Missing the required parameter $apply_validation_rules when calling v1ProductParameterValueIdPut');
        }
        // parse inputs
        $resourcePath = "/v1/product/parameter/value/{id}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        // header params
        if ($apply_validation_rules !== null) {
            $headerParams['Apply-Validation-Rules'] = $this->apiClient->getSerializer()->toHeaderValue($apply_validation_rules);
        }
        // path params
        if ($id !== null) {
            $resourcePath = str_replace(
    ...
    /**
     * Operation v1ProductParameterValueIdsDelete
     *
     * Delete product parameter values
     *
     * @param string $ids up to 100 semicolon delimited value IDs (required)
     * @return \Swagger\Client\Model\ResponsesResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductParameterValueIdsDelete($ids)
    {
        list($response) = $this->v1ProductParameterValueIdsDeleteWithHttpInfo($ids);
        return $response;
    }

    /**
     * Operation v1ProductParameterValueIdsDeleteWithHttpInfo
     *
     * Delete product parameter values
     *
     * @param string $ids up to 100 semicolon delimited value IDs (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductParameterValueIdsDeleteWithHttpInfo($ids)
    {
        // verify the required parameter 'ids' is set
        if ($ids === null) {
            throw new \InvalidArgumentException('Missing the required parameter $ids when calling v1ProductParameterValueIdsDelete');
        }
        // parse inputs
        $resourcePath = "/v1/product/parameter/value/{ids}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                '\Swagger\Client\Model\ResponsesResponse',
                '/v1/product/parameter/value/{ids}'
            );
    ...
    /**
     * Operation v1ProductProductIdParameterParameterIdValuePost
     *
     * Assign Value to Product's Parameter
     *
     * @param int $product_id product ID (required)
     * @param int $parameter_id parameter ID (required)
     * @param \Swagger\Client\Model\RequestsValueRequest $value Value (required)
     * @param bool $apply_validation_rules Apply-Validation-Rules flag (required)
     * @return \Swagger\Client\Model\ResponsesResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductProductIdParameterParameterIdValuePost($product_id, $parameter_id, $value, $apply_validation_rules)
    {
        list($response) = $this->v1ProductProductIdParameterParameterIdValuePostWithHttpInfo($product_id, $parameter_id, $value, $apply_validation_rules);
        return $response;
    }

    /**
     * Operation v1ProductProductIdParameterParameterIdValuePostWithHttpInfo
     *
     * Assign Value to Product's Parameter
     *
     * @param int $product_id product ID (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductProductIdParameterParameterIdValuePostWithHttpInfo($product_id, $parameter_id, $value, $apply_validation_rules)
    {
        // verify the required parameter 'product_id' is set
        if ($product_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $product_id when calling v1ProductProductIdParameterParameterIdValuePost');
        }
        // verify the required parameter 'parameter_id' is set
        if ($parameter_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $parameter_id when calling v1ProductProductIdParameterParameterIdValuePost');
        }
        // verify the required parameter 'value' is set
        if ($value === null) {
            throw new \InvalidArgumentException('Missing the required parameter $value when calling v1ProductProductIdParameterParameterIdValuePost');
        }
        // verify the required parameter 'apply_validation_rules' is set
        if ($apply_validation_rules === null) {
            throw new \InvalidArgumentException('Missing the required parameter $apply_validation_rules when calling v1ProductProductIdParameterParameterIdValuePost');
        }
        // parse inputs
        $resourcePath = "/v1/product/{productId}/parameter/{parameterId}/value";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $headerParams,
                '\Swagger\Client\Model\ResponsesResponse',
                '/v1/product/{productId}/parameter/{parameterId}/value'
            );
