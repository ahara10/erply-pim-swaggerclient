...
class SupplierApi
{
    ...
    /**
     * Operation v1SupplierBulkGetPost
     *
     ...
     * @return \Swagger\Client\Model\ModelsBulkReadSuppliersResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1SupplierBulkGetPost($request)
    {
        list($response) = $this->v1SupplierBulkGetPostWithHttpInfo($request);
        return $response;
    }

    /**
     * Operation v1SupplierBulkGetPostWithHttpInfo
     *
     * Get suppliers in bulk
     *
     * @param \Swagger\Client\Model\ParammodelsBulkReadRequest $request requests have the parameters that the original get request has, but in json format. This way you can apply the parameters to each request separately. (required)
     * @return Array of \Swagger\Client\Model\ModelsBulkReadSuppliersResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1SupplierBulkGetPostWithHttpInfo($request)
    {
        // verify the required parameter 'request' is set
        if ($request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling v1SupplierBulkGetPost');
        }
        // parse inputs
        $resourcePath = "/v1/supplier/bulk/get";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ModelsBulkReadSuppliersResponse',
                '/v1/supplier/bulk/get'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ModelsBulkReadSuppliersResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ModelsBulkReadSuppliersResponse', $e->getResponseHeaders());
    ...
    /**
     * Operation v1SupplierBulkPost
     *
     * Create suppliers in bulk
     *
     * @param \Swagger\Client\Model\ModelsBulkCreateSupplierRequest $request bulk create request (required)
     * @return \Swagger\Client\Model\ResponsesBulkResponseWithResults
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1SupplierBulkPost($request)
    {
        list($response) = $this->v1SupplierBulkPostWithHttpInfo($request);
        return $response;
    }

    /**
     * Operation v1SupplierBulkPostWithHttpInfo
     *
     * Create suppliers in bulk
     *
     * @param \Swagger\Client\Model\ModelsBulkCreateSupplierRequest $request bulk create request (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1SupplierBulkPostWithHttpInfo($request)
    {
        // verify the required parameter 'request' is set
        if ($request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling v1SupplierBulkPost');
        }
        // parse inputs
        $resourcePath = "/v1/supplier/bulk";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
     ...
     * @param bool $with_total_count optionally return total number of active records in the X-Total-Count response header (optional)
     * @return \Swagger\Client\Model\ModelsSupplierResponse[]
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1SupplierGet($skip = null, $take = null, $sort = null, $filter = null, $with_total_count = null)
    {
        list($response) = $this->v1SupplierGetWithHttpInfo($skip, $take, $sort, $filter, $with_total_count);
        return $response;
    }

    /**
     * Operation v1SupplierGetWithHttpInfo
     *
     * Get Suppliers
     *
     * @param int $skip skip n records (optional)
     ...
     * @param string $filter the filter parameter is explained in the &#x60;Filtering &amp; Sorting&#x60; section on top of the Swagger documentation (optional)
     * @param bool $with_total_count optionally return total number of active records in the X-Total-Count response header (optional)
     * @return Array of \Swagger\Client\Model\ModelsSupplierResponse[], HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1SupplierGetWithHttpInfo($skip = null, $take = null, $sort = null, $filter = null, $with_total_count = null)
    {
        // parse inputs
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ModelsSupplierResponse[]',
                '/v1/supplier'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ModelsSupplierResponse[]', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ModelsSupplierResponse[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
    ...
    /**
     * Operation v1SupplierIdPut
     *
     * Update Supplier
     *
     * @param int $id Supplier ID (required)
     * @param \Swagger\Client\Model\ModelsSupplierRequest $supplier Supplier (required)
     * @return \Swagger\Client\Model\ResponsesResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1SupplierIdPut($id, $supplier)
    {
        list($response) = $this->v1SupplierIdPutWithHttpInfo($id, $supplier);
        return $response;
    }

    /**
     * Operation v1SupplierIdPutWithHttpInfo
     *
     * Update Supplier
     *
     * @param int $id Supplier ID (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1SupplierIdPutWithHttpInfo($id, $supplier)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling v1SupplierIdPut');
        }
        // verify the required parameter 'supplier' is set
        if ($supplier === null) {
            throw new \InvalidArgumentException('Missing the required parameter $supplier when calling v1SupplierIdPut');
        }
        // parse inputs
        $resourcePath = "/v1/supplier/{id}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    /**
     * Operation v1SupplierIdsDelete
     *
     * Delete suppliers
     *
     * @param string $ids up to 100 semicolon delimited supplier IDs (required)
     * @return \Swagger\Client\Model\ResponsesResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1SupplierIdsDelete($ids)
    {
        list($response) = $this->v1SupplierIdsDeleteWithHttpInfo($ids);
        return $response;
    }

    /**
     * Operation v1SupplierIdsDeleteWithHttpInfo
     *
     * Delete suppliers
     *
     * @param string $ids up to 100 semicolon delimited supplier IDs (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1SupplierIdsDeleteWithHttpInfo($ids)
    {
        // verify the required parameter 'ids' is set
        if ($ids === null) {
            throw new \InvalidArgumentException('Missing the required parameter $ids when calling v1SupplierIdsDelete');
        }
        // parse inputs
        $resourcePath = "/v1/supplier/{ids}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1SupplierPost($supplier)
    {
        list($response) = $this->v1SupplierPostWithHttpInfo($supplier);
        return $response;
    }

    /**
     * Operation v1SupplierPostWithHttpInfo
     *
     * Create Supplier
     *
     * @param \Swagger\Client\Model\ModelsSupplierRequest $supplier Supplier (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1SupplierPostWithHttpInfo($supplier)
    {
        // verify the required parameter 'supplier' is set
        if ($supplier === null) {
            throw new \InvalidArgumentException('Missing the required parameter $supplier when calling v1SupplierPost');
        }
        // parse inputs
        $resourcePath = "/v1/supplier";
        $httpBody = '';
     ...
     * @param string $sort the sort parameter is explained in the &#x60;Filtering &amp; Sorting&#x60; section on top of the Swagger documentation (optional)
     * @param string $filter the filter parameter is explained in the &#x60;Filtering &amp; Sorting&#x60; section on top of the Swagger documentation (optional)
     * @return \Swagger\Client\Model\ModelsSupplierTypeResponse[]
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1SupplierTypeGet($skip = null, $take = null, $sort = null, $filter = null)
    {
        list($response) = $this->v1SupplierTypeGetWithHttpInfo($skip, $take, $sort, $filter);
        return $response;
    }

    /**
     * Operation v1SupplierTypeGetWithHttpInfo
     *
     * Get Supplier Types
     *
     * @param int $skip skip n records (optional)
     ...
     * @param string $sort the sort parameter is explained in the &#x60;Filtering &amp; Sorting&#x60; section on top of the Swagger documentation (optional)
     * @param string $filter the filter parameter is explained in the &#x60;Filtering &amp; Sorting&#x60; section on top of the Swagger documentation (optional)
     * @return Array of \Swagger\Client\Model\ModelsSupplierTypeResponse[], HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1SupplierTypeGetWithHttpInfo($skip = null, $take = null, $sort = null, $filter = null)
    {
        // parse inputs
        $resourcePath = "/v1/supplier/type";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ModelsSupplierTypeResponse[]',
                '/v1/supplier/type'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ModelsSupplierTypeResponse[]', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ModelsSupplierTypeResponse[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ResponsesMessageResponse', $e->getResponseHeaders());
