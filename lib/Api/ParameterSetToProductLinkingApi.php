<?php
/**
 * ParameterSetToProductLinkingApi
 * PHP version 5
 *
 * @category Class
...
/**
 * ParameterSetToProductLinkingApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   http://github.com/swagger-api/swagger-codegen
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ParameterSetToProductLinkingApi
{
     ...
     *
     * @return ParameterSetToProductLinkingApi
     */
    ...
    /**
     * Operation v1ProductParameterSetIdProductsGet
     *
     ...
     */
    public function v1ProductParameterSetIdProductsGet($id, $skip = null, $take = null)
    {
        list($response) = $this->v1ProductParameterSetIdProductsGetWithHttpInfo($id, $skip, $take);
        return $response;
    }

    /**
     * Operation v1ProductParameterSetIdProductsGetWithHttpInfo
     *
     * Get products that have values for this set
     *
     * @param int $id set ID (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductParameterSetIdProductsGetWithHttpInfo($id, $skip = null, $take = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling v1ProductParameterSetIdProductsGet');
        }
        // parse inputs
        $resourcePath = "/v1/product/parameter/set/{id}/products";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                '/v1/product/parameter/set/{id}/products'
            );
