...
/**
 * SpecialEndpointsApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   http://github.com/swagger-api/swagger-codegen
...
class SpecialEndpointsApi
{
    ...
    /**
     * Operation v1OfflineDbSyncPricelistPricesGet
     *
     * Get Pricelist Prices for Offline DB to sync
     *
     * @param int $last_modified Last modification time (create/update) (required)
     * @param int $pricelist_id price list ID (required)
     * @param int $skip skip n records (optional)
     * @param int $take items to take, default: 20, max: 100000 for this special endpoint (optional)
     * @return \Swagger\Client\Model\ModelsPriceListPrice[]
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1OfflineDbSyncPricelistPricesGet($last_modified, $pricelist_id, $skip = null, $take = null)
    {
        list($response) = $this->v1OfflineDbSyncPricelistPricesGetWithHttpInfo($last_modified, $pricelist_id, $skip, $take);
        return $response;
    }

    /**
     * Operation v1OfflineDbSyncPricelistPricesGetWithHttpInfo
     *
     * Get Pricelist Prices for Offline DB to sync
     *
     * @param int $last_modified Last modification time (create/update) (required)
     ...
     * @param int $skip skip n records (optional)
     * @param int $take items to take, default: 20, max: 100000 for this special endpoint (optional)
     * @return Array of \Swagger\Client\Model\ModelsPriceListPrice[], HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1OfflineDbSyncPricelistPricesGetWithHttpInfo($last_modified, $pricelist_id, $skip = null, $take = null)
    {
        // verify the required parameter 'last_modified' is set
        if ($last_modified === null) {
            throw new \InvalidArgumentException('Missing the required parameter $last_modified when calling v1OfflineDbSyncPricelistPricesGet');
        }
        // verify the required parameter 'pricelist_id' is set
        if ($pricelist_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $pricelist_id when calling v1OfflineDbSyncPricelistPricesGet');
        }
        // parse inputs
        $resourcePath = "/v1/offline-db/sync/pricelist-prices";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        // query params
        if ($pricelist_id !== null) {
            $queryParams['pricelistID'] = $this->apiClient->getSerializer()->toQueryValue($pricelist_id);
        }
        // query params
        if ($skip !== null) {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ModelsPriceListPrice[]',
                '/v1/offline-db/sync/pricelist-prices'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ModelsPriceListPrice[]', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ModelsPriceListPrice[]', $e->getResponseHeaders());
    ...
    /**
     * Operation v1OfflineDbSyncProductGet
     *
     * Get Products for Offline DB to sync, Product pictures: CDN API
     *
     * @param int $last_modified Last modification time (create/update) (required)
     * @param int $skip skip n records (optional)
     * @param int $take items to take, default: 20, max: 8000 for this special endpoint (optional)
     * @param bool $with_total_count optionally return total number of records in the X-Total-Count response header (optional)
     * @return \Swagger\Client\Model\ModelsProductResponseForOfflineDB[]
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1OfflineDbSyncProductGet($last_modified, $skip = null, $take = null, $with_total_count = null)
    {
        list($response) = $this->v1OfflineDbSyncProductGetWithHttpInfo($last_modified, $skip, $take, $with_total_count);
        return $response;
    }

    /**
     * Operation v1OfflineDbSyncProductGetWithHttpInfo
     *
     * Get Products for Offline DB to sync, Product pictures: CDN API
     *
     * @param int $last_modified Last modification time (create/update) (required)
     ...
     * @param int $take items to take, default: 20, max: 8000 for this special endpoint (optional)
     * @param bool $with_total_count optionally return total number of records in the X-Total-Count response header (optional)
     * @return Array of \Swagger\Client\Model\ModelsProductResponseForOfflineDB[], HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1OfflineDbSyncProductGetWithHttpInfo($last_modified, $skip = null, $take = null, $with_total_count = null)
    {
        // verify the required parameter 'last_modified' is set
        if ($last_modified === null) {
            throw new \InvalidArgumentException('Missing the required parameter $last_modified when calling v1OfflineDbSyncProductGet');
        }
        // parse inputs
        $resourcePath = "/v1/offline-db/sync/product";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ModelsProductResponseForOfflineDB[]',
                '/v1/offline-db/sync/product'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ModelsProductResponseForOfflineDB[]', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ModelsProductResponseForOfflineDB[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ResponsesMessageResponse', $e->getResponseHeaders());
    ...
    /**
     * Operation v1UiProductGet
     *
     * Get Products for UI, Product pictures: CDN API
     *
     * @param int $skip skip n records (optional)
     * @param int $take items to take, default: 20, max: 1000 (optional)
     ...
     * @param string $created_date this is an alternative for the added field filter, the format is ISO &#39;yyyy-mm-dd&#39;. (optional)
     * @param bool $with_total_count optionally return total number of records in the X-Total-Count response header (optional)
     * @return \Swagger\Client\Model\ProductsProductResponseForUI[]
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1UiProductGet($skip = null, $take = null, $sort = null, $filter = null, $created_date = null, $with_total_count = null)
    {
        list($response) = $this->v1UiProductGetWithHttpInfo($skip, $take, $sort, $filter, $created_date, $with_total_count);
        return $response;
    }

    /**
     * Operation v1UiProductGetWithHttpInfo
     *
     * Get Products for UI, Product pictures: CDN API
     *
     * @param int $skip skip n records (optional)
     ...
     * @param string $created_date this is an alternative for the added field filter, the format is ISO &#39;yyyy-mm-dd&#39;. (optional)
     * @param bool $with_total_count optionally return total number of records in the X-Total-Count response header (optional)
     * @return Array of \Swagger\Client\Model\ProductsProductResponseForUI[], HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1UiProductGetWithHttpInfo($skip = null, $take = null, $sort = null, $filter = null, $created_date = null, $with_total_count = null)
    {
        // parse inputs
        $resourcePath = "/v1/ui/product";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ProductsProductResponseForUI[]',
                '/v1/ui/product'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ProductsProductResponseForUI[]', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ProductsProductResponseForUI[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ResponsesMessageResponse', $e->getResponseHeaders());
