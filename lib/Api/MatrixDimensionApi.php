...
/**
 * MatrixDimensionApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   http://github.com/swagger-api/swagger-codegen
...
class MatrixDimensionApi
{
    ...
    /**
     * Operation v1MatrixDimensionBulkGetPost
     *
     ...
     * @return \Swagger\Client\Model\MatrixmodelsDimensionBulkReadResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1MatrixDimensionBulkGetPost($request)
    {
        list($response) = $this->v1MatrixDimensionBulkGetPostWithHttpInfo($request);
        return $response;
    }

    /**
     * Operation v1MatrixDimensionBulkGetPostWithHttpInfo
     *
     * Get dimensions in bulk
     *
     * @param \Swagger\Client\Model\ParammodelsBulkReadRequestNoTotalCount $request requests have the parameters that the original get request has, but in json format. This way you can apply the parameters to each request separately. (required)
     * @return Array of \Swagger\Client\Model\MatrixmodelsDimensionBulkReadResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1MatrixDimensionBulkGetPostWithHttpInfo($request)
    {
        // verify the required parameter 'request' is set
        if ($request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling v1MatrixDimensionBulkGetPost');
        }
        // parse inputs
        $resourcePath = "/v1/matrix/dimension/bulk/get";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\MatrixmodelsDimensionBulkReadResponse',
                '/v1/matrix/dimension/bulk/get'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\MatrixmodelsDimensionBulkReadResponse', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\MatrixmodelsDimensionBulkReadResponse', $e->getResponseHeaders());
    ...
    /**
     * Operation v1MatrixDimensionBulkPost
     *
     * Create dimensions in bulk
     *
     * @param \Swagger\Client\Model\MatrixmodelsDimensionBulkCreateRequest $request bulk create request (required)
     * @return \Swagger\Client\Model\ResponsesBulkResponseWithResults
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1MatrixDimensionBulkPost($request)
    {
        list($response) = $this->v1MatrixDimensionBulkPostWithHttpInfo($request);
        return $response;
    }

    /**
     * Operation v1MatrixDimensionBulkPostWithHttpInfo
     *
     * Create dimensions in bulk
     *
     * @param \Swagger\Client\Model\MatrixmodelsDimensionBulkCreateRequest $request bulk create request (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1MatrixDimensionBulkPostWithHttpInfo($request)
    {
        // verify the required parameter 'request' is set
        if ($request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling v1MatrixDimensionBulkPost');
        }
        // parse inputs
        $resourcePath = "/v1/matrix/dimension/bulk";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    /**
     * Operation v1MatrixDimensionGet
     *
     ...
     * @return \Swagger\Client\Model\MatrixmodelsDimensionResponse[]
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1MatrixDimensionGet($skip = null, $take = null, $sort = null, $filter = null)
    {
        list($response) = $this->v1MatrixDimensionGetWithHttpInfo($skip, $take, $sort, $filter);
        return $response;
    }

    /**
     * Operation v1MatrixDimensionGetWithHttpInfo
     *
     * Get Matrix Dimensions
     *
     * @param int $skip skip n records (optional)
     ...
     * @param string $sort the sort parameter is explained in the &#x60;Filtering &amp; Sorting&#x60; section on top of the Swagger documentation (optional)
     * @param string $filter the filter parameter is explained in the &#x60;Filtering &amp; Sorting&#x60; section on top of the Swagger documentation (optional)
     * @return Array of \Swagger\Client\Model\MatrixmodelsDimensionResponse[], HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1MatrixDimensionGetWithHttpInfo($skip = null, $take = null, $sort = null, $filter = null)
    {
        // parse inputs
        $resourcePath = "/v1/matrix/dimension";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\MatrixmodelsDimensionResponse[]',
                '/v1/matrix/dimension'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\MatrixmodelsDimensionResponse[]', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\MatrixmodelsDimensionResponse[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
    ...
    /**
     * Operation v1MatrixDimensionIdMovePut
     *
     * Move Dimension
     *
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1MatrixDimensionIdMovePut($id, $move_request)
    {
        list($response) = $this->v1MatrixDimensionIdMovePutWithHttpInfo($id, $move_request);
        return $response;
    }

    /**
     * Operation v1MatrixDimensionIdMovePutWithHttpInfo
     *
     * Move Dimension
     *
     * @param int $id ID (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1MatrixDimensionIdMovePutWithHttpInfo($id, $move_request)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling v1MatrixDimensionIdMovePut');
        }
        // verify the required parameter 'move_request' is set
        if ($move_request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $move_request when calling v1MatrixDimensionIdMovePut');
        }
        // parse inputs
        $resourcePath = "/v1/matrix/dimension/{id}/move";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    /**
     * Operation v1MatrixDimensionIdPut
     *
     * Update Matrix Dimension
     *
     * @param int $id dimension id (required)
     * @param \Swagger\Client\Model\MatrixmodelsDimensionRequest $matrix_dimension_request DimensionRequest (required)
     * @return \Swagger\Client\Model\ResponsesResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1MatrixDimensionIdPut($id, $matrix_dimension_request)
    {
        list($response) = $this->v1MatrixDimensionIdPutWithHttpInfo($id, $matrix_dimension_request);
        return $response;
    }

    /**
     * Operation v1MatrixDimensionIdPutWithHttpInfo
     *
     * Update Matrix Dimension
     *
     * @param int $id dimension id (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1MatrixDimensionIdPutWithHttpInfo($id, $matrix_dimension_request)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling v1MatrixDimensionIdPut');
        }
        // verify the required parameter 'matrix_dimension_request' is set
        if ($matrix_dimension_request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $matrix_dimension_request when calling v1MatrixDimensionIdPut');
        }
        // parse inputs
        $resourcePath = "/v1/matrix/dimension/{id}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        // body params
        $_tempBody = null;
        if (isset($matrix_dimension_request)) {
            $_tempBody = $matrix_dimension_request;
        }
    ...
    /**
     * Operation v1MatrixDimensionIdsDelete
     *
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1MatrixDimensionIdsDelete($ids)
    {
        list($response) = $this->v1MatrixDimensionIdsDeleteWithHttpInfo($ids);
        return $response;
    }

    /**
     * Operation v1MatrixDimensionIdsDeleteWithHttpInfo
     *
     * Delete Matrix Dimensions
     *
     * @param string $ids up to 100 semicolon delimited IDs (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1MatrixDimensionIdsDeleteWithHttpInfo($ids)
    {
        // verify the required parameter 'ids' is set
        if ($ids === null) {
            throw new \InvalidArgumentException('Missing the required parameter $ids when calling v1MatrixDimensionIdsDelete');
        }
        // parse inputs
        $resourcePath = "/v1/matrix/dimension/{ids}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    /**
     * Operation v1MatrixDimensionPost
     *
     * Create Matrix Dimension
     *
     * @param \Swagger\Client\Model\MatrixmodelsDimensionRequest $matrix_dimension_request matrixDimensionRequest (required)
     * @return \Swagger\Client\Model\ResponsesResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1MatrixDimensionPost($matrix_dimension_request)
    {
        list($response) = $this->v1MatrixDimensionPostWithHttpInfo($matrix_dimension_request);
        return $response;
    }

    /**
     * Operation v1MatrixDimensionPostWithHttpInfo
     *
     * Create Matrix Dimension
     *
     * @param \Swagger\Client\Model\MatrixmodelsDimensionRequest $matrix_dimension_request matrixDimensionRequest (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1MatrixDimensionPostWithHttpInfo($matrix_dimension_request)
    {
        // verify the required parameter 'matrix_dimension_request' is set
        if ($matrix_dimension_request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $matrix_dimension_request when calling v1MatrixDimensionPost');
        }
        // parse inputs
        $resourcePath = "/v1/matrix/dimension";
        $httpBody = '';
