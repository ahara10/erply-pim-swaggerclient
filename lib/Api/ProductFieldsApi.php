...
class ProductFieldsApi
{
    ...
    /**
     * Operation v1ProductFieldsInheritedGet
     *
     ...
     */
    public function v1ProductFieldsInheritedGet()
    {
        list($response) = $this->v1ProductFieldsInheritedGetWithHttpInfo();
        return $response;
    }

    /**
     * Operation v1ProductFieldsInheritedGetWithHttpInfo
     *
     * Read product fields that will be inherited from matrix products
     *
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductFieldsInheritedGetWithHttpInfo()
    {
        // parse inputs
        $resourcePath = "/v1/product/fields/inherited";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    /**
     * Operation v1ProductFieldsInheritedPatch
     *
     * Set product fields that will be inherited from matrix products
     *
     * @param \Swagger\Client\Model\ProductsProductInheritedFieldsRequest $request request (required)
     * @return \Swagger\Client\Model\ResponsesResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductFieldsInheritedPatch($request)
    {
        list($response) = $this->v1ProductFieldsInheritedPatchWithHttpInfo($request);
        return $response;
    }

    /**
     * Operation v1ProductFieldsInheritedPatchWithHttpInfo
     *
     * Set product fields that will be inherited from matrix products
     *
     * @param \Swagger\Client\Model\ProductsProductInheritedFieldsRequest $request request (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductFieldsInheritedPatchWithHttpInfo($request)
    {
        // verify the required parameter 'request' is set
        if ($request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling v1ProductFieldsInheritedPatch');
        }
        // parse inputs
        $resourcePath = "/v1/product/fields/inherited";
        $httpBody = '';
    ...
    /**
     * Operation v1ProductFieldsPermissionsGet
     *
     * Read permissions for product fields
     *
     * @param int $user_group_id user group ID (required)
     * @return \Swagger\Client\Model\ProductsProductFieldsPermissions
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductFieldsPermissionsGet($user_group_id)
    {
        list($response) = $this->v1ProductFieldsPermissionsGetWithHttpInfo($user_group_id);
        return $response;
    }

    /**
     * Operation v1ProductFieldsPermissionsGetWithHttpInfo
     *
     * Read permissions for product fields
     *
     * @param int $user_group_id user group ID (required)
     * @return Array of \Swagger\Client\Model\ProductsProductFieldsPermissions, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductFieldsPermissionsGetWithHttpInfo($user_group_id)
    {
        // verify the required parameter 'user_group_id' is set
        if ($user_group_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $user_group_id when calling v1ProductFieldsPermissionsGet');
        }
        // parse inputs
        $resourcePath = "/v1/product/fields/permissions";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\ProductsProductFieldsPermissions',
                '/v1/product/fields/permissions'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\ProductsProductFieldsPermissions', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ProductsProductFieldsPermissions', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\ResponsesMessageResponse', $e->getResponseHeaders());
    ...
    /**
     * Operation v1ProductFieldsPermissionsPatch
     *
     * Set permissions for product fields, permissions are user group based
     *
     * @param int $user_group_id user group ID (required)
     * @param \Swagger\Client\Model\ProductsProductFieldsPermissions $request request (required)
     * @return \Swagger\Client\Model\ResponsesResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductFieldsPermissionsPatch($user_group_id, $request)
    {
        list($response) = $this->v1ProductFieldsPermissionsPatchWithHttpInfo($user_group_id, $request);
        return $response;
    }

    /**
     * Operation v1ProductFieldsPermissionsPatchWithHttpInfo
     *
     * Set permissions for product fields, permissions are user group based
     *
     * @param int $user_group_id user group ID (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductFieldsPermissionsPatchWithHttpInfo($user_group_id, $request)
    {
        // verify the required parameter 'user_group_id' is set
        if ($user_group_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $user_group_id when calling v1ProductFieldsPermissionsPatch');
        }
        // verify the required parameter 'request' is set
        if ($request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling v1ProductFieldsPermissionsPatch');
        }
        // parse inputs
        $resourcePath = "/v1/product/fields/permissions";
        $httpBody = '';
