...
/**
 * WarehouseLocationsApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   http://github.com/swagger-api/swagger-codegen
...
class WarehouseLocationsApi
{
    ...
    /**
     * Operation v1WarehouseLocationsIdPatch
     *
     * Update a warehouse location
     *
     * @param int $id location ID (required)
     * @param \Swagger\Client\Model\WarehousesUpdateLocationRequest $update_request update request (required)
     * @return \Swagger\Client\Model\ResponsesResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1WarehouseLocationsIdPatch($id, $update_request)
    {
        list($response) = $this->v1WarehouseLocationsIdPatchWithHttpInfo($id, $update_request);
        return $response;
    }

    /**
     * Operation v1WarehouseLocationsIdPatchWithHttpInfo
     *
     * Update a warehouse location
     *
     * @param int $id location ID (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1WarehouseLocationsIdPatchWithHttpInfo($id, $update_request)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling v1WarehouseLocationsIdPatch');
        }
        // verify the required parameter 'update_request' is set
        if ($update_request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $update_request when calling v1WarehouseLocationsIdPatch');
        }
        // parse inputs
        $resourcePath = "/v1/warehouse/locations/{id}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    /**
     * Operation v1WarehouseLocationsIdsDelete
     *
     * Delete Warehouse Locations by IDs
     *
     * @param string $ids up to 100 semicolon delimited Warehouse Location IDs (required)
     * @return \Swagger\Client\Model\ResponsesResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1WarehouseLocationsIdsDelete($ids)
    {
        list($response) = $this->v1WarehouseLocationsIdsDeleteWithHttpInfo($ids);
        return $response;
    }

    /**
     * Operation v1WarehouseLocationsIdsDeleteWithHttpInfo
     *
     * Delete Warehouse Locations by IDs
     *
     * @param string $ids up to 100 semicolon delimited Warehouse Location IDs (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1WarehouseLocationsIdsDeleteWithHttpInfo($ids)
    {
        // verify the required parameter 'ids' is set
        if ($ids === null) {
            throw new \InvalidArgumentException('Missing the required parameter $ids when calling v1WarehouseLocationsIdsDelete');
        }
        // parse inputs
        $resourcePath = "/v1/warehouse/locations/{ids}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    /**
     * Operation v1WarehouseLocationsPost
     *
     * Create a Warehouse Location
     *
     * @param \Swagger\Client\Model\WarehousesCreateLocationRequest $request request (required)
     * @return \Swagger\Client\Model\ResponsesResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1WarehouseLocationsPost($request)
    {
        list($response) = $this->v1WarehouseLocationsPostWithHttpInfo($request);
        return $response;
    }

    /**
     * Operation v1WarehouseLocationsPostWithHttpInfo
     *
     * Create a Warehouse Location
     *
     * @param \Swagger\Client\Model\WarehousesCreateLocationRequest $request request (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1WarehouseLocationsPostWithHttpInfo($request)
    {
        // verify the required parameter 'request' is set
        if ($request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling v1WarehouseLocationsPost');
        }
        // parse inputs
        $resourcePath = "/v1/warehouse/locations";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
