...
class CountryApi
{
     ...
     * @return \Swagger\Client\Model\CountriesCountryResponse[]
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductCountryGet($skip = null, $take = null, $sort = null, $filter = null)
    {
        list($response) = $this->v1ProductCountryGetWithHttpInfo($skip, $take, $sort, $filter);
        return $response;
    }

    /**
     * Operation v1ProductCountryGetWithHttpInfo
     *
     * Get Countries
     *
     * @param int $skip skip n records (optional)
     ...
     * @param string $sort the sort parameter is explained in the &#x60;Filtering &amp; Sorting&#x60; section on top of the Swagger documentation (optional)
     * @param string $filter the filter parameter is explained in the &#x60;Filtering &amp; Sorting&#x60; section on top of the Swagger documentation (optional)
     * @return Array of \Swagger\Client\Model\CountriesCountryResponse[], HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductCountryGetWithHttpInfo($skip = null, $take = null, $sort = null, $filter = null)
    {
        // parse inputs
        $resourcePath = "/v1/product/country";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\CountriesCountryResponse[]',
                '/v1/product/country'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\CountriesCountryResponse[]', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\CountriesCountryResponse[]', $e->getResponseHeaders());
    ...
    /**
     * Operation v1ProductCountryIdPut
     *
     * Update a Country
     *
     * @param \Swagger\Client\Model\CountriesCountryRequest $request request (required)
     * @param int $id country ID (required)
     * @return \Swagger\Client\Model\ResponsesResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductCountryIdPut($request, $id)
    {
        list($response) = $this->v1ProductCountryIdPutWithHttpInfo($request, $id);
        return $response;
    }

    /**
     * Operation v1ProductCountryIdPutWithHttpInfo
     *
     * Update a Country
     *
     * @param \Swagger\Client\Model\CountriesCountryRequest $request request (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductCountryIdPutWithHttpInfo($request, $id)
    {
        // verify the required parameter 'request' is set
        if ($request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling v1ProductCountryIdPut');
        }
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling v1ProductCountryIdPut');
        }
        // parse inputs
        $resourcePath = "/v1/product/country/{id}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    /**
     * Operation v1ProductCountryIdsDelete
     *
     * Delete countries by IDs
     *
     * @param string $ids up to 100 semicolon delimited country IDs (required)
     * @return \Swagger\Client\Model\ResponsesResponse
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductCountryIdsDelete($ids)
    {
        list($response) = $this->v1ProductCountryIdsDeleteWithHttpInfo($ids);
        return $response;
    }

    /**
     * Operation v1ProductCountryIdsDeleteWithHttpInfo
     *
     * Delete countries by IDs
     *
     * @param string $ids up to 100 semicolon delimited country IDs (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductCountryIdsDeleteWithHttpInfo($ids)
    {
        // verify the required parameter 'ids' is set
        if ($ids === null) {
            throw new \InvalidArgumentException('Missing the required parameter $ids when calling v1ProductCountryIdsDelete');
        }
        // parse inputs
        $resourcePath = "/v1/product/country/{ids}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    /**
     * Operation v1ProductCountryPost
     *
     * Create a Country
     *
     * @param \Swagger\Client\Model\CountriesCountryRequest $request request (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductCountryPost($request)
    {
        list($response) = $this->v1ProductCountryPostWithHttpInfo($request);
        return $response;
    }

    /**
     * Operation v1ProductCountryPostWithHttpInfo
     *
     * Create a Country
     *
     * @param \Swagger\Client\Model\CountriesCountryRequest $request request (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function v1ProductCountryPostWithHttpInfo($request)
    {
        // verify the required parameter 'request' is set
        if ($request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling v1ProductCountryPost');
        }
        // parse inputs
        $resourcePath = "/v1/product/country";
        $httpBody = '';
